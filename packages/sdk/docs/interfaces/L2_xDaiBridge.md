...
- [callStatic](L2_xDaiBridge.md#callstatic)
- [estimateGas](L2_xDaiBridge.md#estimategas)
- [filters](L2_xDaiBridge.md#filters)
- [functions](L2_xDaiBridge.md#functions)
- [interface](L2_xDaiBridge.md#interface)
- [off](L2_xDaiBridge.md#off)
- [on](L2_xDaiBridge.md#on)
- [once](L2_xDaiBridge.md#once)
- [populateTransaction](L2_xDaiBridge.md#populatetransaction)
- [removeListener](L2_xDaiBridge.md#removelistener)

### Methods

- [activeChainIds](L2_xDaiBridge.md#activechainids)
- [addActiveChainIds](L2_xDaiBridge.md#addactivechainids)
- [addBonder](L2_xDaiBridge.md#addbonder)
- [ammWrapper](L2_xDaiBridge.md#ammwrapper)
- [attach](L2_xDaiBridge.md#attach)
- [bondWithdrawal](L2_xDaiBridge.md#bondwithdrawal)
- [bondWithdrawalAndDistribute](L2_xDaiBridge.md#bondwithdrawalanddistribute)
- [commitTransfers](L2_xDaiBridge.md#committransfers)
- [connect](L2_xDaiBridge.md#connect)
- [defaultGasLimit](L2_xDaiBridge.md#defaultgaslimit)
- [deployed](L2_xDaiBridge.md#deployed)
- [distribute](L2_xDaiBridge.md#distribute)
- [getBondedWithdrawalAmount](L2_xDaiBridge.md#getbondedwithdrawalamount)
- [getChainId](L2_xDaiBridge.md#getchainid)
- [getCredit](L2_xDaiBridge.md#getcredit)
- [getDebitAndAdditionalDebit](L2_xDaiBridge.md#getdebitandadditionaldebit)
- [getIsBonder](L2_xDaiBridge.md#getisbonder)
- [getNextTransferNonce](L2_xDaiBridge.md#getnexttransfernonce)
- [getRawDebit](L2_xDaiBridge.md#getrawdebit)
- [getTransferId](L2_xDaiBridge.md#gettransferid)
- [getTransferRoot](L2_xDaiBridge.md#gettransferroot)
- [getTransferRootId](L2_xDaiBridge.md#gettransferrootid)
- [hToken](L2_xDaiBridge.md#htoken)
- [isTransferIdSpent](L2_xDaiBridge.md#istransferidspent)
- [l1BridgeAddress](L2_xDaiBridge.md#l1bridgeaddress)
- [l1BridgeCaller](L2_xDaiBridge.md#l1bridgecaller)
- [l1ChainId](L2_xDaiBridge.md#l1chainid)
- [l1Governance](L2_xDaiBridge.md#l1governance)
- [lastCommitTimeForChainId](L2_xDaiBridge.md#lastcommittimeforchainid)
- [listeners](L2_xDaiBridge.md#listeners)
- [maxPendingTransfers](L2_xDaiBridge.md#maxpendingtransfers)
- [messenger](L2_xDaiBridge.md#messenger)
- [minBonderBps](L2_xDaiBridge.md#minbonderbps)
- [minBonderFeeAbsolute](L2_xDaiBridge.md#minbonderfeeabsolute)
- [minimumForceCommitDelay](L2_xDaiBridge.md#minimumforcecommitdelay)
- [pendingAmountForChainId](L2_xDaiBridge.md#pendingamountforchainid)
- [pendingTransferIdsForChainId](L2_xDaiBridge.md#pendingtransferidsforchainid)
- [queryFilter](L2_xDaiBridge.md#queryfilter)
- [removeActiveChainIds](L2_xDaiBridge.md#removeactivechainids)
- [removeAllListeners](L2_xDaiBridge.md#removealllisteners)
- [removeBonder](L2_xDaiBridge.md#removebonder)
- [rescueTransferRoot](L2_xDaiBridge.md#rescuetransferroot)
- [send](L2_xDaiBridge.md#send)
- [setAmmWrapper](L2_xDaiBridge.md#setammwrapper)
- [setDefaultGasLimit](L2_xDaiBridge.md#setdefaultgaslimit)
- [setHopBridgeTokenOwner](L2_xDaiBridge.md#sethopbridgetokenowner)
- [setL1BridgeAddress](L2_xDaiBridge.md#setl1bridgeaddress)
- [setL1BridgeCaller](L2_xDaiBridge.md#setl1bridgecaller)
- [setL1Governance](L2_xDaiBridge.md#setl1governance)
- [setMaxPendingTransfers](L2_xDaiBridge.md#setmaxpendingtransfers)
- [setMessenger](L2_xDaiBridge.md#setmessenger)
- [setMinimumBonderFeeRequirements](L2_xDaiBridge.md#setminimumbonderfeerequirements)
- [setMinimumForceCommitDelay](L2_xDaiBridge.md#setminimumforcecommitdelay)
- [setTransferRoot](L2_xDaiBridge.md#settransferroot)
- [settleBondedWithdrawal](L2_xDaiBridge.md#settlebondedwithdrawal)
- [settleBondedWithdrawals](L2_xDaiBridge.md#settlebondedwithdrawals)
- [stake](L2_xDaiBridge.md#stake)
- [transferNonceIncrementer](L2_xDaiBridge.md#transfernonceincrementer)
- [unstake](L2_xDaiBridge.md#unstake)
- [withdraw](L2_xDaiBridge.md#withdraw)
...
• **interface**: `L2_xDaiBridgeInterface`
...
• **off**: `OnEvent`\<[`L2_xDaiBridge`](L2_xDaiBridge.md)\>
...
• **on**: `OnEvent`\<[`L2_xDaiBridge`](L2_xDaiBridge.md)\>
...
• **once**: `OnEvent`\<[`L2_xDaiBridge`](L2_xDaiBridge.md)\>
...
• **removeListener**: `OnEvent`\<[`L2_xDaiBridge`](L2_xDaiBridge.md)\>
...
▸ **deployed**(): `Promise`\<[`L2_xDaiBridge`](L2_xDaiBridge.md)\>

#### Returns

`Promise`\<[`L2_xDaiBridge`](L2_xDaiBridge.md)\>
