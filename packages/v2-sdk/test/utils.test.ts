import { getComputedPathId, getComputedTransferId } from '#utils/index.js'
import { ethers } from 'ethers'

describe('getComputedTransferId', () => {
  it('should get computed transfer id', () => {
    ...
    const result = getComputedTransferId(previousTransferId, transferDataHash)
    console.log(result)
    expect(result).toBe('0x55d71bbb1e0f5f297dabb748558edc0eb79c6e9fa41346f34121fc31cbcb1203')
  })
})

describe.skip('getComputedPathId', () => {
  it('should return the correct keccak256 hash', () => {
    ...
    const result = getComputedPathId(chainId0, token0, chainId1, token1, initialReserve)
