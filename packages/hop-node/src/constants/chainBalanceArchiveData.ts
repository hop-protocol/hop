...
type UnwithdrawnTransfers = {
  [key in Token]: Partial<{
    [key in Chain]: string
  }>
}

type InFlightL1ToL2Transfers = {
  [key in Token]: Partial<{
    [key in Chain]: string
  }>
}

type L1TokensSentDirectlyToBridge = {
  [key in Token]: string
}
...
const UnwithdrawnTransfers: UnwithdrawnTransfers = {
  [Token.USDC]: {
...
const InFlightL1ToL2Transfers: InFlightL1ToL2Transfers = {
  [Token.USDC]: {
    [Chain.Gnosis]: '0',
    [Chain.Polygon]: '0',
    [Chain.Optimism]: '0',
