# Interface: IOVM\_L2CrossDomainMessenger
...
- [callStatic](IOVM_L2CrossDomainMessenger.md#callstatic)
- [estimateGas](IOVM_L2CrossDomainMessenger.md#estimategas)
- [filters](IOVM_L2CrossDomainMessenger.md#filters)
- [functions](IOVM_L2CrossDomainMessenger.md#functions)
- [interface](IOVM_L2CrossDomainMessenger.md#interface)
- [off](IOVM_L2CrossDomainMessenger.md#off)
- [on](IOVM_L2CrossDomainMessenger.md#on)
- [once](IOVM_L2CrossDomainMessenger.md#once)
- [populateTransaction](IOVM_L2CrossDomainMessenger.md#populatetransaction)
- [removeListener](IOVM_L2CrossDomainMessenger.md#removelistener)

### Methods

- [attach](IOVM_L2CrossDomainMessenger.md#attach)
- [connect](IOVM_L2CrossDomainMessenger.md#connect)
- [deployed](IOVM_L2CrossDomainMessenger.md#deployed)
- [deposit](IOVM_L2CrossDomainMessenger.md#deposit)
- [listeners](IOVM_L2CrossDomainMessenger.md#listeners)
- [queryFilter](IOVM_L2CrossDomainMessenger.md#queryfilter)
- [removeAllListeners](IOVM_L2CrossDomainMessenger.md#removealllisteners)
- [sendMessage](IOVM_L2CrossDomainMessenger.md#sendmessage)
- [xDomainMessageSender](IOVM_L2CrossDomainMessenger.md#xdomainmessagesender)
...
• **off**: `OnEvent`\<[`IOVM_L2CrossDomainMessenger`](IOVM_L2CrossDomainMessenger.md)\>
...
• **on**: `OnEvent`\<[`IOVM_L2CrossDomainMessenger`](IOVM_L2CrossDomainMessenger.md)\>
...
• **once**: `OnEvent`\<[`IOVM_L2CrossDomainMessenger`](IOVM_L2CrossDomainMessenger.md)\>
...
• **removeListener**: `OnEvent`\<[`IOVM_L2CrossDomainMessenger`](IOVM_L2CrossDomainMessenger.md)\>
...
▸ **deployed**(): `Promise`\<[`IOVM_L2CrossDomainMessenger`](IOVM_L2CrossDomainMessenger.md)\>

#### Returns

`Promise`\<[`IOVM_L2CrossDomainMessenger`](IOVM_L2CrossDomainMessenger.md)\>
