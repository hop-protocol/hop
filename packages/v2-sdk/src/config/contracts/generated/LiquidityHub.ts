...
export interface LiquidityHubInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "getTokenBusId",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "getTokenBusInfo",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "minBonderStake",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "withdrawClaims",
    values: [
      PromiseOrValue<BytesLike>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>
...
export interface LiquidityHub extends BaseContract {
  ...
  functions: {
    ...
    bond(
      tokenBusId: PromiseOrValue<BytesLike>,
      ...
      attestedNonce: PromiseOrValue<BigNumberish>,
      attestedTotalSent: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    initTokenBus(
      ...
      rateDelta: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "TransferBonded(bytes32,bytes32,address,uint256,uint256,uint256)"(
      claimId?: PromiseOrValue<BytesLike> | null,
      tokenBusId?: PromiseOrValue<BytesLike> | null,
    ...
    "TransferSent(bytes32,bytes32,address,uint256,uint256,uint256)"(
      claimId?: PromiseOrValue<BytesLike> | null,
      tokenBusId?: PromiseOrValue<BytesLike> | null,
      to?: PromiseOrValue<string> | null,
      amount?: null,
