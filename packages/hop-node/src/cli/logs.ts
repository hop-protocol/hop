...
root
  ...
  .option('--error', 'Filter for error logs', parseBool)
  .option('--warn', 'Filter for warn logs', parseBool)
  .option('--info', 'Filter for info logs', parseBool)
  ...
  .option('--show-log-groups', 'Show all CloudWatch log group names', parseBool)
  .option('--show-log-streams', 'Show all CloudWatch log stream names', parseBool)
