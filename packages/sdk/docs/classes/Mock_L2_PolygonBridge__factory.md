# Class: Mock\_L2\_PolygonBridge\_\_factory

## Table of contents

### Constructors

- [constructor](Mock_L2_PolygonBridge__factory.md#constructor)

### Properties

- [abi](Mock_L2_PolygonBridge__factory.md#abi)

### Methods

- [connect](Mock_L2_PolygonBridge__factory.md#connect)
- [createInterface](Mock_L2_PolygonBridge__factory.md#createinterface)

## Constructors

### <a id="constructor" name="constructor"></a> constructor

• **new Mock_L2_PolygonBridge__factory**(): [`Mock_L2_PolygonBridge__factory`](Mock_L2_PolygonBridge__factory.md)

#### Returns

[`Mock_L2_PolygonBridge__factory`](Mock_L2_PolygonBridge__factory.md)
...
▸ **connect**(`address`, `signerOrProvider`): [`Mock_L2_PolygonBridge`](../interfaces/Mock_L2_PolygonBridge.md)
...
[`Mock_L2_PolygonBridge`](../interfaces/Mock_L2_PolygonBridge.md)

___

### <a id="createinterface" name="createinterface"></a> createInterface

▸ **createInterface**(): `Mock_L2_PolygonBridgeInterface`

#### Returns

`Mock_L2_PolygonBridgeInterface`
