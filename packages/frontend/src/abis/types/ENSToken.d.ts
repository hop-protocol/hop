...
interface ENSTokenInterface extends ethers.utils.Interface {
  functions: {
    ...
    "claimTokens(uint256,address,bytes32[])": FunctionFragment;
    ...
    "minimumMintInterval()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "minimumMintInterval",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class ENSToken extends BaseContract {
  ...
  functions: {
    ...
    minimumMintInterval(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    sweep(dest: string, overrides?: CallOverrides): Promise<void>;
