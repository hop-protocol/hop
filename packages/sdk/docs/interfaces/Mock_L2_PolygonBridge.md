# Interface: Mock\_L2\_PolygonBridge

## Hierarchy

- `BaseContract`

  ↳ **`Mock_L2_PolygonBridge`**

## Table of contents

### Properties

- [callStatic](Mock_L2_PolygonBridge.md#callstatic)
- [estimateGas](Mock_L2_PolygonBridge.md#estimategas)
- [filters](Mock_L2_PolygonBridge.md#filters)
- [functions](Mock_L2_PolygonBridge.md#functions)
- [interface](Mock_L2_PolygonBridge.md#interface)
- [off](Mock_L2_PolygonBridge.md#off)
- [on](Mock_L2_PolygonBridge.md#on)
- [once](Mock_L2_PolygonBridge.md#once)
- [populateTransaction](Mock_L2_PolygonBridge.md#populatetransaction)
- [removeListener](Mock_L2_PolygonBridge.md#removelistener)

### Methods

- [activeChainIds](Mock_L2_PolygonBridge.md#activechainids)
- [addActiveChainIds](Mock_L2_PolygonBridge.md#addactivechainids)
- [addBonder](Mock_L2_PolygonBridge.md#addbonder)
- [ammWrapper](Mock_L2_PolygonBridge.md#ammwrapper)
- [attach](Mock_L2_PolygonBridge.md#attach)
- [bondWithdrawal](Mock_L2_PolygonBridge.md#bondwithdrawal)
- [bondWithdrawalAndDistribute](Mock_L2_PolygonBridge.md#bondwithdrawalanddistribute)
- [commitTransfers](Mock_L2_PolygonBridge.md#committransfers)
- [connect](Mock_L2_PolygonBridge.md#connect)
- [deployed](Mock_L2_PolygonBridge.md#deployed)
- [distribute](Mock_L2_PolygonBridge.md#distribute)
- [getBondedWithdrawalAmount](Mock_L2_PolygonBridge.md#getbondedwithdrawalamount)
- [getChainId](Mock_L2_PolygonBridge.md#getchainid)
- [getCredit](Mock_L2_PolygonBridge.md#getcredit)
- [getDebitAndAdditionalDebit](Mock_L2_PolygonBridge.md#getdebitandadditionaldebit)
- [getIsBonder](Mock_L2_PolygonBridge.md#getisbonder)
- [getNextTransferNonce](Mock_L2_PolygonBridge.md#getnexttransfernonce)
- [getRawDebit](Mock_L2_PolygonBridge.md#getrawdebit)
- [getTransferId](Mock_L2_PolygonBridge.md#gettransferid)
- [getTransferRoot](Mock_L2_PolygonBridge.md#gettransferroot)
- [getTransferRootId](Mock_L2_PolygonBridge.md#gettransferrootid)
- [hToken](Mock_L2_PolygonBridge.md#htoken)
- [isTransferIdSpent](Mock_L2_PolygonBridge.md#istransferidspent)
- [l1BridgeAddress](Mock_L2_PolygonBridge.md#l1bridgeaddress)
- [l1BridgeCaller](Mock_L2_PolygonBridge.md#l1bridgecaller)
- [l1Governance](Mock_L2_PolygonBridge.md#l1governance)
- [lastCommitTimeForChainId](Mock_L2_PolygonBridge.md#lastcommittimeforchainid)
- [listeners](Mock_L2_PolygonBridge.md#listeners)
- [maxPendingTransfers](Mock_L2_PolygonBridge.md#maxpendingtransfers)
- [messengerProxy](Mock_L2_PolygonBridge.md#messengerproxy)
- [minBonderBps](Mock_L2_PolygonBridge.md#minbonderbps)
- [minBonderFeeAbsolute](Mock_L2_PolygonBridge.md#minbonderfeeabsolute)
- [minimumForceCommitDelay](Mock_L2_PolygonBridge.md#minimumforcecommitdelay)
- [pendingAmountForChainId](Mock_L2_PolygonBridge.md#pendingamountforchainid)
- [pendingTransferIdsForChainId](Mock_L2_PolygonBridge.md#pendingtransferidsforchainid)
- [queryFilter](Mock_L2_PolygonBridge.md#queryfilter)
- [removeActiveChainIds](Mock_L2_PolygonBridge.md#removeactivechainids)
- [removeAllListeners](Mock_L2_PolygonBridge.md#removealllisteners)
- [removeBonder](Mock_L2_PolygonBridge.md#removebonder)
- [rescueTransferRoot](Mock_L2_PolygonBridge.md#rescuetransferroot)
- [send](Mock_L2_PolygonBridge.md#send)
- [setAmmWrapper](Mock_L2_PolygonBridge.md#setammwrapper)
- [setHopBridgeTokenOwner](Mock_L2_PolygonBridge.md#sethopbridgetokenowner)
- [setL1BridgeAddress](Mock_L2_PolygonBridge.md#setl1bridgeaddress)
- [setL1BridgeCaller](Mock_L2_PolygonBridge.md#setl1bridgecaller)
- [setL1Governance](Mock_L2_PolygonBridge.md#setl1governance)
- [setMaxPendingTransfers](Mock_L2_PolygonBridge.md#setmaxpendingtransfers)
- [setMessengerProxy](Mock_L2_PolygonBridge.md#setmessengerproxy)
- [setMinimumBonderFeeRequirements](Mock_L2_PolygonBridge.md#setminimumbonderfeerequirements)
- [setMinimumForceCommitDelay](Mock_L2_PolygonBridge.md#setminimumforcecommitdelay)
- [setTransferRoot](Mock_L2_PolygonBridge.md#settransferroot)
- [settleBondedWithdrawal](Mock_L2_PolygonBridge.md#settlebondedwithdrawal)
- [settleBondedWithdrawals](Mock_L2_PolygonBridge.md#settlebondedwithdrawals)
- [stake](Mock_L2_PolygonBridge.md#stake)
- [transferNonceIncrementer](Mock_L2_PolygonBridge.md#transfernonceincrementer)
- [unstake](Mock_L2_PolygonBridge.md#unstake)
- [withdraw](Mock_L2_PolygonBridge.md#withdraw)
...
| `setMessengerProxy` | (`_messengerProxy`: `PromiseOrValue`\<`string`\>, `overrides?`: `CallOverrides`) => `Promise`\<`void`\> |
...
| `setMessengerProxy` | (`_messengerProxy`: `PromiseOrValue`\<`string`\>, `overrides?`: `Overrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  }) => `Promise`\<`BigNumber`\> |
...
| `setMessengerProxy` | (`_messengerProxy`: `PromiseOrValue`\<`string`\>, `overrides?`: `Overrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  }) => `Promise`\<`ContractTransaction`\> |
...
• **interface**: `Mock_L2_PolygonBridgeInterface`
...
• **off**: `OnEvent`\<[`Mock_L2_PolygonBridge`](Mock_L2_PolygonBridge.md)\>
...
• **on**: `OnEvent`\<[`Mock_L2_PolygonBridge`](Mock_L2_PolygonBridge.md)\>
...
• **once**: `OnEvent`\<[`Mock_L2_PolygonBridge`](Mock_L2_PolygonBridge.md)\>
...
| `setMessengerProxy` | (`_messengerProxy`: `PromiseOrValue`\<`string`\>, `overrides?`: `Overrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  }) => `Promise`\<`PopulatedTransaction`\> |
...
• **removeListener**: `OnEvent`\<[`Mock_L2_PolygonBridge`](Mock_L2_PolygonBridge.md)\>
...
▸ **deployed**(): `Promise`\<[`Mock_L2_PolygonBridge`](Mock_L2_PolygonBridge.md)\>

#### Returns

`Promise`\<[`Mock_L2_PolygonBridge`](Mock_L2_PolygonBridge.md)\>
...
### <a id="messengerproxy" name="messengerproxy"></a> messengerProxy

▸ **messengerProxy**(`overrides?`): `Promise`\<`string`\>
...
### <a id="setmessengerproxy" name="setmessengerproxy"></a> setMessengerProxy

▸ **setMessengerProxy**(`_messengerProxy`, `overrides?`): `Promise`\<`ContractTransaction`\>

#### Parameters

| Name | Type |
| :------ | :------ |
| `_messengerProxy` | `PromiseOrValue`\<`string`\> |
| `overrides?` | `Overrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  } |
