...
exports.ArbitrumRelayer = void 0;
const sdk_1 = require("@arbitrum/sdk");
class ArbitrumRelayer {
    ...
    async getExitPopulatedTx(l2TxHash) {
        ...
        const initiatingTxReceipt = new sdk_1.L2TransactionReceipt(l2Receipt);
    ...
    async getL1ToL2Messages(l1TxHash) {
        ...
        const l1TxReceipt = new sdk_1.L1TransactionReceipt(l1Receipt);
        return l1TxReceipt.getL1ToL2Messages(this.l2Provider);
    }
    async isTransactionRedeemed(l1TxHash, messageIndex = 0) {
        const status = await this.getMessageStatus(l1TxHash, messageIndex);
        return status === sdk_1.L1ToL2MessageStatus.REDEEMED;
    }
}
exports.ArbitrumRelayer = ArbitrumRelayer;
