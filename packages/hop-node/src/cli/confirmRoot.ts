...
import { ConfirmRootsData } from '#src/watchers/ConfirmRootsWatcher.js'
...
import { getConfirmRootsWatcher } from '#src/watchers/watchers.js'
import { getEnabledNetworks } from '#src/config/index.js'
