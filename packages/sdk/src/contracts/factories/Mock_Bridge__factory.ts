...
import type { Mock_Bridge, Mock_BridgeInterface } from "../Mock_Bridge.js";
...
export class Mock_Bridge__factory {
  static readonly abi = _abi;
  static createInterface(): Mock_BridgeInterface {
    return new utils.Interface(_abi) as Mock_BridgeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Mock_Bridge {
    return new Contract(address, _abi, signerOrProvider) as Mock_Bridge;
  }
}
