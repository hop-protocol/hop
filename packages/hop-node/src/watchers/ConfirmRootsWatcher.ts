...
import { ChallengePeriodMs } from '#src/constants/index.js'
import { ExitableTransferRoot } from '#src/db/TransferRootsDb.js'
...
import { getEnabledNetworks, config as globalConfig } from '#src/config/index.js'
