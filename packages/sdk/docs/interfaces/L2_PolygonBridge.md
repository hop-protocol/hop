...
- [callStatic](L2_PolygonBridge.md#callstatic)
- [estimateGas](L2_PolygonBridge.md#estimategas)
- [filters](L2_PolygonBridge.md#filters)
- [functions](L2_PolygonBridge.md#functions)
- [interface](L2_PolygonBridge.md#interface)
- [off](L2_PolygonBridge.md#off)
- [on](L2_PolygonBridge.md#on)
- [once](L2_PolygonBridge.md#once)
- [populateTransaction](L2_PolygonBridge.md#populatetransaction)
- [removeListener](L2_PolygonBridge.md#removelistener)

### Methods

- [activeChainIds](L2_PolygonBridge.md#activechainids)
- [addActiveChainIds](L2_PolygonBridge.md#addactivechainids)
- [addBonder](L2_PolygonBridge.md#addbonder)
- [ammWrapper](L2_PolygonBridge.md#ammwrapper)
- [attach](L2_PolygonBridge.md#attach)
- [bondWithdrawal](L2_PolygonBridge.md#bondwithdrawal)
- [bondWithdrawalAndDistribute](L2_PolygonBridge.md#bondwithdrawalanddistribute)
- [commitTransfers](L2_PolygonBridge.md#committransfers)
- [connect](L2_PolygonBridge.md#connect)
- [deployed](L2_PolygonBridge.md#deployed)
- [distribute](L2_PolygonBridge.md#distribute)
- [getBondedWithdrawalAmount](L2_PolygonBridge.md#getbondedwithdrawalamount)
- [getChainId](L2_PolygonBridge.md#getchainid)
- [getCredit](L2_PolygonBridge.md#getcredit)
- [getDebitAndAdditionalDebit](L2_PolygonBridge.md#getdebitandadditionaldebit)
- [getIsBonder](L2_PolygonBridge.md#getisbonder)
- [getNextTransferNonce](L2_PolygonBridge.md#getnexttransfernonce)
- [getRawDebit](L2_PolygonBridge.md#getrawdebit)
- [getTransferId](L2_PolygonBridge.md#gettransferid)
- [getTransferRoot](L2_PolygonBridge.md#gettransferroot)
- [getTransferRootId](L2_PolygonBridge.md#gettransferrootid)
- [hToken](L2_PolygonBridge.md#htoken)
- [isTransferIdSpent](L2_PolygonBridge.md#istransferidspent)
- [l1BridgeAddress](L2_PolygonBridge.md#l1bridgeaddress)
- [l1BridgeCaller](L2_PolygonBridge.md#l1bridgecaller)
- [l1Governance](L2_PolygonBridge.md#l1governance)
- [lastCommitTimeForChainId](L2_PolygonBridge.md#lastcommittimeforchainid)
- [listeners](L2_PolygonBridge.md#listeners)
- [maxPendingTransfers](L2_PolygonBridge.md#maxpendingtransfers)
- [messengerProxy](L2_PolygonBridge.md#messengerproxy)
- [minBonderBps](L2_PolygonBridge.md#minbonderbps)
- [minBonderFeeAbsolute](L2_PolygonBridge.md#minbonderfeeabsolute)
- [minimumForceCommitDelay](L2_PolygonBridge.md#minimumforcecommitdelay)
- [pendingAmountForChainId](L2_PolygonBridge.md#pendingamountforchainid)
- [pendingTransferIdsForChainId](L2_PolygonBridge.md#pendingtransferidsforchainid)
- [queryFilter](L2_PolygonBridge.md#queryfilter)
- [removeActiveChainIds](L2_PolygonBridge.md#removeactivechainids)
- [removeAllListeners](L2_PolygonBridge.md#removealllisteners)
- [removeBonder](L2_PolygonBridge.md#removebonder)
- [rescueTransferRoot](L2_PolygonBridge.md#rescuetransferroot)
- [send](L2_PolygonBridge.md#send)
- [setAmmWrapper](L2_PolygonBridge.md#setammwrapper)
- [setHopBridgeTokenOwner](L2_PolygonBridge.md#sethopbridgetokenowner)
- [setL1BridgeAddress](L2_PolygonBridge.md#setl1bridgeaddress)
- [setL1BridgeCaller](L2_PolygonBridge.md#setl1bridgecaller)
- [setL1Governance](L2_PolygonBridge.md#setl1governance)
- [setMaxPendingTransfers](L2_PolygonBridge.md#setmaxpendingtransfers)
- [setMessengerProxy](L2_PolygonBridge.md#setmessengerproxy)
- [setMinimumBonderFeeRequirements](L2_PolygonBridge.md#setminimumbonderfeerequirements)
- [setMinimumForceCommitDelay](L2_PolygonBridge.md#setminimumforcecommitdelay)
- [setTransferRoot](L2_PolygonBridge.md#settransferroot)
- [settleBondedWithdrawal](L2_PolygonBridge.md#settlebondedwithdrawal)
- [settleBondedWithdrawals](L2_PolygonBridge.md#settlebondedwithdrawals)
- [stake](L2_PolygonBridge.md#stake)
- [transferNonceIncrementer](L2_PolygonBridge.md#transfernonceincrementer)
- [unstake](L2_PolygonBridge.md#unstake)
- [withdraw](L2_PolygonBridge.md#withdraw)
...
• **interface**: `L2_PolygonBridgeInterface`
...
• **off**: `OnEvent`\<[`L2_PolygonBridge`](L2_PolygonBridge.md)\>
...
• **on**: `OnEvent`\<[`L2_PolygonBridge`](L2_PolygonBridge.md)\>
...
• **once**: `OnEvent`\<[`L2_PolygonBridge`](L2_PolygonBridge.md)\>
...
• **removeListener**: `OnEvent`\<[`L2_PolygonBridge`](L2_PolygonBridge.md)\>
...
▸ **deployed**(): `Promise`\<[`L2_PolygonBridge`](L2_PolygonBridge.md)\>

#### Returns

`Promise`\<[`L2_PolygonBridge`](L2_PolygonBridge.md)\>
