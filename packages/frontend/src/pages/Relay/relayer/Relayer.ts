...
// Optimism-chain resource metering is not accurately estimated with all RPC providers. Because of this,
// confirmations entering into an Optimism chain need a custom gasLimit to ensure the tx is propagated to the chain.
export const DefaultL1RelayGasLimit = 1_000_000
...
export abstract class Relayer<Message, MessageStatus> {
  protected readonly l1Wallet: Signer | Provider
  protected readonly l2Wallet: Signer | Provider
