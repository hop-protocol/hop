# Interface: IOVM\_L1CrossDomainMessenger
...
- [callStatic](IOVM_L1CrossDomainMessenger.md#callstatic)
- [estimateGas](IOVM_L1CrossDomainMessenger.md#estimategas)
- [filters](IOVM_L1CrossDomainMessenger.md#filters)
- [functions](IOVM_L1CrossDomainMessenger.md#functions)
- [interface](IOVM_L1CrossDomainMessenger.md#interface)
- [off](IOVM_L1CrossDomainMessenger.md#off)
- [on](IOVM_L1CrossDomainMessenger.md#on)
- [once](IOVM_L1CrossDomainMessenger.md#once)
- [populateTransaction](IOVM_L1CrossDomainMessenger.md#populatetransaction)
- [removeListener](IOVM_L1CrossDomainMessenger.md#removelistener)

### Methods

- [attach](IOVM_L1CrossDomainMessenger.md#attach)
- [connect](IOVM_L1CrossDomainMessenger.md#connect)
- [deployed](IOVM_L1CrossDomainMessenger.md#deployed)
- [deposit](IOVM_L1CrossDomainMessenger.md#deposit)
- [listeners](IOVM_L1CrossDomainMessenger.md#listeners)
- [queryFilter](IOVM_L1CrossDomainMessenger.md#queryfilter)
- [removeAllListeners](IOVM_L1CrossDomainMessenger.md#removealllisteners)
- [sendMessage](IOVM_L1CrossDomainMessenger.md#sendmessage)
- [xDomainMessageSender](IOVM_L1CrossDomainMessenger.md#xdomainmessagesender)
...
• **interface**: `IOVM_L1CrossDomainMessengerInterface`
...
• **off**: `OnEvent`\<[`IOVM_L1CrossDomainMessenger`](IOVM_L1CrossDomainMessenger.md)\>
...
• **on**: `OnEvent`\<[`IOVM_L1CrossDomainMessenger`](IOVM_L1CrossDomainMessenger.md)\>
...
• **once**: `OnEvent`\<[`IOVM_L1CrossDomainMessenger`](IOVM_L1CrossDomainMessenger.md)\>
...
• **removeListener**: `OnEvent`\<[`IOVM_L1CrossDomainMessenger`](IOVM_L1CrossDomainMessenger.md)\>
...
▸ **deployed**(): `Promise`\<[`IOVM_L1CrossDomainMessenger`](IOVM_L1CrossDomainMessenger.md)\>

#### Returns

`Promise`\<[`IOVM_L1CrossDomainMessenger`](IOVM_L1CrossDomainMessenger.md)\>
