# Class: Mock\_L2\_ArbitrumBridge\_\_factory

## Table of contents

### Constructors

- [constructor](Mock_L2_ArbitrumBridge__factory.md#constructor)

### Properties

- [abi](Mock_L2_ArbitrumBridge__factory.md#abi)

### Methods

- [connect](Mock_L2_ArbitrumBridge__factory.md#connect)
- [createInterface](Mock_L2_ArbitrumBridge__factory.md#createinterface)

## Constructors

### <a id="constructor" name="constructor"></a> constructor

• **new Mock_L2_ArbitrumBridge__factory**(): [`Mock_L2_ArbitrumBridge__factory`](Mock_L2_ArbitrumBridge__factory.md)

#### Returns

[`Mock_L2_ArbitrumBridge__factory`](Mock_L2_ArbitrumBridge__factory.md)
...
▸ **connect**(`address`, `signerOrProvider`): [`Mock_L2_ArbitrumBridge`](../interfaces/Mock_L2_ArbitrumBridge.md)
...
[`Mock_L2_ArbitrumBridge`](../interfaces/Mock_L2_ArbitrumBridge.md)

___

### <a id="createinterface" name="createinterface"></a> createInterface

▸ **createInterface**(): `Mock_L2_ArbitrumBridgeInterface`

#### Returns

`Mock_L2_ArbitrumBridgeInterface`
