...
- [getCctpBridgeAddress](Base.md#getcctpbridgeaddress)
- [getCctpL1BridgeAddress](Base.md#getcctpl1bridgeaddress)
- [getCctpL2BridgeAddress](Base.md#getcctpl2bridgeaddress)
- [getCctpMessageTransmitterAddress](Base.md#getcctpmessagetransmitteraddress)
...
- [getContractExists](Base.md#getcontractexists)
...
• **new Base**(`networkOrOptionsObject`, `signer?`, `chainProviders?`): [`Base`](Base.md)
