...
} from "../../static/ArbitrumGlobalInbox";
...
export class ArbitrumGlobalInbox__factory {
  static readonly abi = _abi;
  static createInterface(): ArbitrumGlobalInboxInterface {
    return new utils.Interface(_abi) as ArbitrumGlobalInboxInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ArbitrumGlobalInbox {
    return new Contract(address, _abi, signerOrProvider) as ArbitrumGlobalInbox;
  }
}
