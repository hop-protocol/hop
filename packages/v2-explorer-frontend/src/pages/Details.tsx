...
import { useTransferDetails } from '../hooks/useTransferDetails.js'
import { CopyToClipboardText } from '../components/CopyToClipboardText.js'
...
const DetailRow = ({ loading, label, value, link, imageUrl, skeletonWidth = 200, maxWidth }: any) => {
