...
export interface DispatcherInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "getFee"
      | "initialBundleNonce"
      | "maxBundleMessagesForChainId"
      | "messageFeeForChainId"
      | "owner"
  ...
  encodeFunctionData(
    functionFragment: "initialBundleNonce",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "maxBundleMessagesForChainId",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "messageFeeForChainId",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
...
export interface Dispatcher extends BaseContract {
  ...
  filters: {
    "BundleCommitted(bytes32,bytes32,uint256,uint256,uint256)"(
      bundleNonce?: PromiseOrValue<BytesLike> | null,
      bundleRoot?: null,
      bundleFees?: null,
