...
- [callStatic](ISwapGuarded.md#callstatic)
- [estimateGas](ISwapGuarded.md#estimategas)
- [filters](ISwapGuarded.md#filters)
- [functions](ISwapGuarded.md#functions)
- [interface](ISwapGuarded.md#interface)
- [off](ISwapGuarded.md#off)
- [on](ISwapGuarded.md#on)
- [once](ISwapGuarded.md#once)
- [populateTransaction](ISwapGuarded.md#populatetransaction)
- [removeListener](ISwapGuarded.md#removelistener)

### Methods

- [addLiquidity](ISwapGuarded.md#addliquidity)
- [attach](ISwapGuarded.md#attach)
- [calculateRemoveLiquidity](ISwapGuarded.md#calculateremoveliquidity)
- [calculateRemoveLiquidityOneToken](ISwapGuarded.md#calculateremoveliquidityonetoken)
- [calculateSwap](ISwapGuarded.md#calculateswap)
- [calculateTokenAmount](ISwapGuarded.md#calculatetokenamount)
- [connect](ISwapGuarded.md#connect)
- [deployed](ISwapGuarded.md#deployed)
- [getA](ISwapGuarded.md#geta)
- [getAllowlist](ISwapGuarded.md#getallowlist)
- [getToken](ISwapGuarded.md#gettoken)
- [getTokenBalance](ISwapGuarded.md#gettokenbalance)
- [getTokenIndex](ISwapGuarded.md#gettokenindex)
- [getVirtualPrice](ISwapGuarded.md#getvirtualprice)
- [isGuarded](ISwapGuarded.md#isguarded)
- [listeners](ISwapGuarded.md#listeners)
- [queryFilter](ISwapGuarded.md#queryfilter)
- [removeAllListeners](ISwapGuarded.md#removealllisteners)
- [removeLiquidity](ISwapGuarded.md#removeliquidity)
- [removeLiquidityImbalance](ISwapGuarded.md#removeliquidityimbalance)
- [removeLiquidityOneToken](ISwapGuarded.md#removeliquidityonetoken)
- [swap](ISwapGuarded.md#swap)
- [updateUserWithdrawFee](ISwapGuarded.md#updateuserwithdrawfee)
...
| Name | Type |
| :------ | :------ |
| `addLiquidity` | (`amounts`: `PromiseOrValue`\<`BigNumberish`\>[], `minToMint`: `PromiseOrValue`\<`BigNumberish`\>, `deadline`: `PromiseOrValue`\<`BigNumberish`\>, `merkleProof`: `PromiseOrValue`\<`BytesLike`\>[], `overrides?`: `CallOverrides`) => `Promise`\<`BigNumber`\> |
...
| Name | Type |
| :------ | :------ |
| `addLiquidity` | (`amounts`: `PromiseOrValue`\<`BigNumberish`\>[], `minToMint`: `PromiseOrValue`\<`BigNumberish`\>, `deadline`: `PromiseOrValue`\<`BigNumberish`\>, `merkleProof`: `PromiseOrValue`\<`BytesLike`\>[], `overrides?`: `Overrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  }) => `Promise`\<`BigNumber`\> |
| `calculateRemoveLiquidity` | (`amount`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `CallOverrides`) => `Promise`\<`BigNumber`\> |
| `calculateRemoveLiquidityOneToken` | (`tokenAmount`: `PromiseOrValue`\<`BigNumberish`\>, `tokenIndex`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `CallOverrides`) => `Promise`\<`BigNumber`\> |
| `calculateSwap` | (`tokenIndexFrom`: `PromiseOrValue`\<`BigNumberish`\>, `tokenIndexTo`: `PromiseOrValue`\<`BigNumberish`\>, `dx`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `CallOverrides`) => `Promise`\<`BigNumber`\> |
| `calculateTokenAmount` | (`amounts`: `PromiseOrValue`\<`BigNumberish`\>[], `deposit`: `PromiseOrValue`\<`boolean`\>, `overrides?`: `CallOverrides`) => `Promise`\<`BigNumber`\> |
...
| Name | Type |
| :------ | :------ |
| `addLiquidity` | (`amounts`: `PromiseOrValue`\<`BigNumberish`\>[], `minToMint`: `PromiseOrValue`\<`BigNumberish`\>, `deadline`: `PromiseOrValue`\<`BigNumberish`\>, `merkleProof`: `PromiseOrValue`\<`BytesLike`\>[], `overrides?`: `Overrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  }) => `Promise`\<`ContractTransaction`\> |
| `calculateRemoveLiquidity` | (`amount`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `CallOverrides`) => `Promise`\<[`BigNumber`[]]\> |
...
• **off**: `OnEvent`\<[`ISwapGuarded`](ISwapGuarded.md)\>
...
• **on**: `OnEvent`\<[`ISwapGuarded`](ISwapGuarded.md)\>
...
• **once**: `OnEvent`\<[`ISwapGuarded`](ISwapGuarded.md)\>
...
| Name | Type |
| :------ | :------ |
| `addLiquidity` | (`amounts`: `PromiseOrValue`\<`BigNumberish`\>[], `minToMint`: `PromiseOrValue`\<`BigNumberish`\>, `deadline`: `PromiseOrValue`\<`BigNumberish`\>, `merkleProof`: `PromiseOrValue`\<`BytesLike`\>[], `overrides?`: `Overrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  }) => `Promise`\<`PopulatedTransaction`\> |
...
• **removeListener**: `OnEvent`\<[`ISwapGuarded`](ISwapGuarded.md)\>
...
▸ **addLiquidity**(`amounts`, `minToMint`, `deadline`, `merkleProof`, `overrides?`): `Promise`\<`ContractTransaction`\>
...
▸ **deployed**(): `Promise`\<[`ISwapGuarded`](ISwapGuarded.md)\>

#### Returns

`Promise`\<[`ISwapGuarded`](ISwapGuarded.md)\>
