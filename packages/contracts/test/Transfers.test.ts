...
//     await IGetMessengerWrapperDefaults(CHAIN_IDS.OPTIMISM_TESTNET_1, l1_ovm1_messenger.address, l2_ovm1_bridge.address)
...
//     // Initialize bridge wrapper
//     await getMessengerWrapperDefaults(CHAIN_IDS.OPTIMISM_TESTNET_1, l1_ovm2_messengerWrapper, l2_ovm2_messenger.address, l2_ovm2_bridge.address)
