...
export interface StakingRegistryInterface extends utils.Interface {
  functions: {
    ...
    "challengeIterationPeriod()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "challengeIterationPeriod",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface StakingRegistry extends BaseContract {
  ...
  functions: {
    ...
    challengeIterationPeriod(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    getWithdrawableBalance(
      staker: PromiseOrValue<string>,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { withdrawableBalance: BigNumber }>;
