...
import type {
  SpokeMessageBridge,
  SpokeMessageBridgeInterface,
  RouteStruct,
} from "../../generated/SpokeMessageBridge";
...
export class SpokeMessageBridge__factory {
  static readonly abi = _abi;
  static createInterface(): SpokeMessageBridgeInterface {
    return new utils.Interface(_abi) as SpokeMessageBridgeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SpokeMessageBridge {
    return new Contract(address, _abi, signerOrProvider) as SpokeMessageBridge;
  }
}
