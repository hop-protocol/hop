  ...
  return async (...args: any[]) => {
    ...
    while (true) {
      try {
        ...
        const errorRegex = /(timeout|timedout|ETIMEDOUT|ENETUNREACH|ECONNRESET|bad response|response error|rate limit|too many concurrent requests|socket hang up)/gi
