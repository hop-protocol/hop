# Interface: Mock\_L2\_xDaiBridge
...
- [callStatic](Mock_L2_xDaiBridge.md#callstatic)
- [estimateGas](Mock_L2_xDaiBridge.md#estimategas)
- [filters](Mock_L2_xDaiBridge.md#filters)
- [functions](Mock_L2_xDaiBridge.md#functions)
- [interface](Mock_L2_xDaiBridge.md#interface)
- [off](Mock_L2_xDaiBridge.md#off)
- [on](Mock_L2_xDaiBridge.md#on)
- [once](Mock_L2_xDaiBridge.md#once)
- [populateTransaction](Mock_L2_xDaiBridge.md#populatetransaction)
- [removeListener](Mock_L2_xDaiBridge.md#removelistener)

### Methods

- [activeChainIds](Mock_L2_xDaiBridge.md#activechainids)
- [addActiveChainIds](Mock_L2_xDaiBridge.md#addactivechainids)
- [addBonder](Mock_L2_xDaiBridge.md#addbonder)
- [ammWrapper](Mock_L2_xDaiBridge.md#ammwrapper)
- [attach](Mock_L2_xDaiBridge.md#attach)
- [bondWithdrawal](Mock_L2_xDaiBridge.md#bondwithdrawal)
- [bondWithdrawalAndDistribute](Mock_L2_xDaiBridge.md#bondwithdrawalanddistribute)
- [commitTransfers](Mock_L2_xDaiBridge.md#committransfers)
- [connect](Mock_L2_xDaiBridge.md#connect)
- [defaultGasLimit](Mock_L2_xDaiBridge.md#defaultgaslimit)
- [deployed](Mock_L2_xDaiBridge.md#deployed)
- [distribute](Mock_L2_xDaiBridge.md#distribute)
- [getBondedWithdrawalAmount](Mock_L2_xDaiBridge.md#getbondedwithdrawalamount)
- [getChainId](Mock_L2_xDaiBridge.md#getchainid)
- [getCredit](Mock_L2_xDaiBridge.md#getcredit)
- [getDebitAndAdditionalDebit](Mock_L2_xDaiBridge.md#getdebitandadditionaldebit)
- [getIsBonder](Mock_L2_xDaiBridge.md#getisbonder)
- [getNextTransferNonce](Mock_L2_xDaiBridge.md#getnexttransfernonce)
- [getRawDebit](Mock_L2_xDaiBridge.md#getrawdebit)
- [getTransferId](Mock_L2_xDaiBridge.md#gettransferid)
- [getTransferRoot](Mock_L2_xDaiBridge.md#gettransferroot)
- [getTransferRootId](Mock_L2_xDaiBridge.md#gettransferrootid)
- [hToken](Mock_L2_xDaiBridge.md#htoken)
- [isTransferIdSpent](Mock_L2_xDaiBridge.md#istransferidspent)
- [l1BridgeAddress](Mock_L2_xDaiBridge.md#l1bridgeaddress)
- [l1BridgeCaller](Mock_L2_xDaiBridge.md#l1bridgecaller)
- [l1ChainId](Mock_L2_xDaiBridge.md#l1chainid)
- [l1Governance](Mock_L2_xDaiBridge.md#l1governance)
- [lastCommitTimeForChainId](Mock_L2_xDaiBridge.md#lastcommittimeforchainid)
- [listeners](Mock_L2_xDaiBridge.md#listeners)
- [maxPendingTransfers](Mock_L2_xDaiBridge.md#maxpendingtransfers)
- [messenger](Mock_L2_xDaiBridge.md#messenger)
- [minBonderBps](Mock_L2_xDaiBridge.md#minbonderbps)
- [minBonderFeeAbsolute](Mock_L2_xDaiBridge.md#minbonderfeeabsolute)
- [minimumForceCommitDelay](Mock_L2_xDaiBridge.md#minimumforcecommitdelay)
- [pendingAmountForChainId](Mock_L2_xDaiBridge.md#pendingamountforchainid)
- [pendingTransferIdsForChainId](Mock_L2_xDaiBridge.md#pendingtransferidsforchainid)
- [queryFilter](Mock_L2_xDaiBridge.md#queryfilter)
- [removeActiveChainIds](Mock_L2_xDaiBridge.md#removeactivechainids)
- [removeAllListeners](Mock_L2_xDaiBridge.md#removealllisteners)
- [removeBonder](Mock_L2_xDaiBridge.md#removebonder)
- [rescueTransferRoot](Mock_L2_xDaiBridge.md#rescuetransferroot)
- [send](Mock_L2_xDaiBridge.md#send)
- [setAmmWrapper](Mock_L2_xDaiBridge.md#setammwrapper)
- [setDefaultGasLimit](Mock_L2_xDaiBridge.md#setdefaultgaslimit)
- [setHopBridgeTokenOwner](Mock_L2_xDaiBridge.md#sethopbridgetokenowner)
- [setL1BridgeAddress](Mock_L2_xDaiBridge.md#setl1bridgeaddress)
- [setL1BridgeCaller](Mock_L2_xDaiBridge.md#setl1bridgecaller)
- [setL1Governance](Mock_L2_xDaiBridge.md#setl1governance)
- [setMaxPendingTransfers](Mock_L2_xDaiBridge.md#setmaxpendingtransfers)
- [setMessenger](Mock_L2_xDaiBridge.md#setmessenger)
- [setMinimumBonderFeeRequirements](Mock_L2_xDaiBridge.md#setminimumbonderfeerequirements)
- [setMinimumForceCommitDelay](Mock_L2_xDaiBridge.md#setminimumforcecommitdelay)
- [setTransferRoot](Mock_L2_xDaiBridge.md#settransferroot)
- [settleBondedWithdrawal](Mock_L2_xDaiBridge.md#settlebondedwithdrawal)
- [settleBondedWithdrawals](Mock_L2_xDaiBridge.md#settlebondedwithdrawals)
- [stake](Mock_L2_xDaiBridge.md#stake)
- [transferNonceIncrementer](Mock_L2_xDaiBridge.md#transfernonceincrementer)
- [unstake](Mock_L2_xDaiBridge.md#unstake)
- [withdraw](Mock_L2_xDaiBridge.md#withdraw)
...
• **off**: `OnEvent`\<[`Mock_L2_xDaiBridge`](Mock_L2_xDaiBridge.md)\>
...
• **on**: `OnEvent`\<[`Mock_L2_xDaiBridge`](Mock_L2_xDaiBridge.md)\>
...
• **once**: `OnEvent`\<[`Mock_L2_xDaiBridge`](Mock_L2_xDaiBridge.md)\>
...
• **removeListener**: `OnEvent`\<[`Mock_L2_xDaiBridge`](Mock_L2_xDaiBridge.md)\>
...
▸ **deployed**(): `Promise`\<[`Mock_L2_xDaiBridge`](Mock_L2_xDaiBridge.md)\>

#### Returns

`Promise`\<[`Mock_L2_xDaiBridge`](Mock_L2_xDaiBridge.md)\>
...
▸ **l1ChainId**(`overrides?`): `Promise`\<`string`\>
