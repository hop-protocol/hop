...
- [callStatic](L1_ETH_Bridge.md#callstatic)
- [estimateGas](L1_ETH_Bridge.md#estimategas)
- [filters](L1_ETH_Bridge.md#filters)
- [functions](L1_ETH_Bridge.md#functions)
- [interface](L1_ETH_Bridge.md#interface)
- [off](L1_ETH_Bridge.md#off)
- [on](L1_ETH_Bridge.md#on)
- [once](L1_ETH_Bridge.md#once)
- [populateTransaction](L1_ETH_Bridge.md#populatetransaction)
- [removeListener](L1_ETH_Bridge.md#removelistener)

### Methods

- [CHALLENGE\_AMOUNT\_DIVISOR](L1_ETH_Bridge.md#challenge_amount_divisor)
- [TIME\_SLOT\_SIZE](L1_ETH_Bridge.md#time_slot_size)
- [addBonder](L1_ETH_Bridge.md#addbonder)
- [attach](L1_ETH_Bridge.md#attach)
- [bondTransferRoot](L1_ETH_Bridge.md#bondtransferroot)
- [bondWithdrawal](L1_ETH_Bridge.md#bondwithdrawal)
- [chainBalance](L1_ETH_Bridge.md#chainbalance)
- [challengePeriod](L1_ETH_Bridge.md#challengeperiod)
- [challengeResolutionPeriod](L1_ETH_Bridge.md#challengeresolutionperiod)
- [challengeTransferBond](L1_ETH_Bridge.md#challengetransferbond)
- [confirmTransferRoot](L1_ETH_Bridge.md#confirmtransferroot)
- [connect](L1_ETH_Bridge.md#connect)
- [crossDomainMessengerWrappers](L1_ETH_Bridge.md#crossdomainmessengerwrappers)
- [deployed](L1_ETH_Bridge.md#deployed)
- [getBondForTransferAmount](L1_ETH_Bridge.md#getbondfortransferamount)
- [getBondedWithdrawalAmount](L1_ETH_Bridge.md#getbondedwithdrawalamount)
- [getChainId](L1_ETH_Bridge.md#getchainid)
- [getChallengeAmountForTransferAmount](L1_ETH_Bridge.md#getchallengeamountfortransferamount)
- [getCredit](L1_ETH_Bridge.md#getcredit)
- [getDebitAndAdditionalDebit](L1_ETH_Bridge.md#getdebitandadditionaldebit)
- [getIsBonder](L1_ETH_Bridge.md#getisbonder)
- [getRawDebit](L1_ETH_Bridge.md#getrawdebit)
- [getTimeSlot](L1_ETH_Bridge.md#gettimeslot)
- [getTransferId](L1_ETH_Bridge.md#gettransferid)
- [getTransferRoot](L1_ETH_Bridge.md#gettransferroot)
- [getTransferRootId](L1_ETH_Bridge.md#gettransferrootid)
- [governance](L1_ETH_Bridge.md#governance)
- [isChainIdPaused](L1_ETH_Bridge.md#ischainidpaused)
- [isTransferIdSpent](L1_ETH_Bridge.md#istransferidspent)
- [listeners](L1_ETH_Bridge.md#listeners)
- [minTransferRootBondDelay](L1_ETH_Bridge.md#mintransferrootbonddelay)
- [queryFilter](L1_ETH_Bridge.md#queryfilter)
- [removeAllListeners](L1_ETH_Bridge.md#removealllisteners)
- [removeBonder](L1_ETH_Bridge.md#removebonder)
- [rescueTransferRoot](L1_ETH_Bridge.md#rescuetransferroot)
- [resolveChallenge](L1_ETH_Bridge.md#resolvechallenge)
- [sendToL2](L1_ETH_Bridge.md#sendtol2)
- [setChainIdDepositsPaused](L1_ETH_Bridge.md#setchainiddepositspaused)
- [setChallengePeriod](L1_ETH_Bridge.md#setchallengeperiod)
- [setChallengeResolutionPeriod](L1_ETH_Bridge.md#setchallengeresolutionperiod)
- [setCrossDomainMessengerWrapper](L1_ETH_Bridge.md#setcrossdomainmessengerwrapper)
- [setGovernance](L1_ETH_Bridge.md#setgovernance)
- [setMinTransferRootBondDelay](L1_ETH_Bridge.md#setmintransferrootbonddelay)
- [settleBondedWithdrawal](L1_ETH_Bridge.md#settlebondedwithdrawal)
- [settleBondedWithdrawals](L1_ETH_Bridge.md#settlebondedwithdrawals)
- [stake](L1_ETH_Bridge.md#stake)
- [timeSlotToAmountBonded](L1_ETH_Bridge.md#timeslottoamountbonded)
- [transferBonds](L1_ETH_Bridge.md#transferbonds)
- [transferRootCommittedAt](L1_ETH_Bridge.md#transferrootcommittedat)
- [unstake](L1_ETH_Bridge.md#unstake)
- [withdraw](L1_ETH_Bridge.md#withdraw)
...
• **off**: `OnEvent`\<[`L1_ETH_Bridge`](L1_ETH_Bridge.md)\>
...
• **on**: `OnEvent`\<[`L1_ETH_Bridge`](L1_ETH_Bridge.md)\>
...
• **once**: `OnEvent`\<[`L1_ETH_Bridge`](L1_ETH_Bridge.md)\>
...
• **removeListener**: `OnEvent`\<[`L1_ETH_Bridge`](L1_ETH_Bridge.md)\>
...
▸ **deployed**(): `Promise`\<[`L1_ETH_Bridge`](L1_ETH_Bridge.md)\>

#### Returns

`Promise`\<[`L1_ETH_Bridge`](L1_ETH_Bridge.md)\>
