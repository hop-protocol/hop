...
export interface Mock_L2_PolygonBridgeInterface extends utils.Interface {
  functions: {
...
export interface L1_BridgeMessageEventObject {
  data: string;
}
export type L1_BridgeMessageEvent = TypedEvent<
  [string],
  L1_BridgeMessageEventObject
>;

export type L1_BridgeMessageEventFilter =
  TypedEventFilter<L1_BridgeMessageEvent>;
...
export interface Mock_L2_PolygonBridge extends BaseContract {
