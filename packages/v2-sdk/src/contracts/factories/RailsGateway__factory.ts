...
const _abi = [
  ...
  {
    type: "function",
    name: "getHardConfirmedBucketIndex",
    inputs: [
      {
        name: "pathId",
        type: "bytes32",
  ...
  {
    type: "function",
    name: "getTotalWithdrawableAtClaimId",
    inputs: [
      {
        name: "pathId",
        type: "bytes32",
