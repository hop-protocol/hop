...
- [callStatic](L2_Bridge.md#callstatic)
- [estimateGas](L2_Bridge.md#estimategas)
- [filters](L2_Bridge.md#filters)
- [functions](L2_Bridge.md#functions)
- [interface](L2_Bridge.md#interface)
- [off](L2_Bridge.md#off)
- [on](L2_Bridge.md#on)
- [once](L2_Bridge.md#once)
- [populateTransaction](L2_Bridge.md#populatetransaction)
- [removeListener](L2_Bridge.md#removelistener)

### Methods

- [activeChainIds](L2_Bridge.md#activechainids)
- [addActiveChainIds](L2_Bridge.md#addactivechainids)
- [addBonder](L2_Bridge.md#addbonder)
- [ammWrapper](L2_Bridge.md#ammwrapper)
- [attach](L2_Bridge.md#attach)
- [bondWithdrawal](L2_Bridge.md#bondwithdrawal)
- [bondWithdrawalAndDistribute](L2_Bridge.md#bondwithdrawalanddistribute)
- [commitTransfers](L2_Bridge.md#committransfers)
- [connect](L2_Bridge.md#connect)
- [deployed](L2_Bridge.md#deployed)
- [distribute](L2_Bridge.md#distribute)
- [getBondedWithdrawalAmount](L2_Bridge.md#getbondedwithdrawalamount)
- [getChainId](L2_Bridge.md#getchainid)
- [getCredit](L2_Bridge.md#getcredit)
- [getDebitAndAdditionalDebit](L2_Bridge.md#getdebitandadditionaldebit)
- [getIsBonder](L2_Bridge.md#getisbonder)
- [getNextTransferNonce](L2_Bridge.md#getnexttransfernonce)
- [getRawDebit](L2_Bridge.md#getrawdebit)
- [getTransferId](L2_Bridge.md#gettransferid)
- [getTransferRoot](L2_Bridge.md#gettransferroot)
- [getTransferRootId](L2_Bridge.md#gettransferrootid)
- [hToken](L2_Bridge.md#htoken)
- [isTransferIdSpent](L2_Bridge.md#istransferidspent)
- [l1BridgeAddress](L2_Bridge.md#l1bridgeaddress)
- [l1BridgeCaller](L2_Bridge.md#l1bridgecaller)
- [l1Governance](L2_Bridge.md#l1governance)
- [lastCommitTimeForChainId](L2_Bridge.md#lastcommittimeforchainid)
- [listeners](L2_Bridge.md#listeners)
- [maxPendingTransfers](L2_Bridge.md#maxpendingtransfers)
- [minBonderBps](L2_Bridge.md#minbonderbps)
- [minBonderFeeAbsolute](L2_Bridge.md#minbonderfeeabsolute)
- [minimumForceCommitDelay](L2_Bridge.md#minimumforcecommitdelay)
- [pendingAmountForChainId](L2_Bridge.md#pendingamountforchainid)
- [pendingTransferIdsForChainId](L2_Bridge.md#pendingtransferidsforchainid)
- [queryFilter](L2_Bridge.md#queryfilter)
- [removeActiveChainIds](L2_Bridge.md#removeactivechainids)
- [removeAllListeners](L2_Bridge.md#removealllisteners)
- [removeBonder](L2_Bridge.md#removebonder)
- [rescueTransferRoot](L2_Bridge.md#rescuetransferroot)
- [send](L2_Bridge.md#send)
- [setAmmWrapper](L2_Bridge.md#setammwrapper)
- [setHopBridgeTokenOwner](L2_Bridge.md#sethopbridgetokenowner)
- [setL1BridgeAddress](L2_Bridge.md#setl1bridgeaddress)
- [setL1BridgeCaller](L2_Bridge.md#setl1bridgecaller)
- [setL1Governance](L2_Bridge.md#setl1governance)
- [setMaxPendingTransfers](L2_Bridge.md#setmaxpendingtransfers)
- [setMinimumBonderFeeRequirements](L2_Bridge.md#setminimumbonderfeerequirements)
- [setMinimumForceCommitDelay](L2_Bridge.md#setminimumforcecommitdelay)
- [setTransferRoot](L2_Bridge.md#settransferroot)
- [settleBondedWithdrawal](L2_Bridge.md#settlebondedwithdrawal)
- [settleBondedWithdrawals](L2_Bridge.md#settlebondedwithdrawals)
- [stake](L2_Bridge.md#stake)
- [transferNonceIncrementer](L2_Bridge.md#transfernonceincrementer)
- [unstake](L2_Bridge.md#unstake)
- [withdraw](L2_Bridge.md#withdraw)
...
• **off**: `OnEvent`\<[`L2_Bridge`](L2_Bridge.md)\>
...
• **on**: `OnEvent`\<[`L2_Bridge`](L2_Bridge.md)\>
...
• **once**: `OnEvent`\<[`L2_Bridge`](L2_Bridge.md)\>
...
• **removeListener**: `OnEvent`\<[`L2_Bridge`](L2_Bridge.md)\>
...
▸ **deployed**(): `Promise`\<[`L2_Bridge`](L2_Bridge.md)\>

#### Returns

`Promise`\<[`L2_Bridge`](L2_Bridge.md)\>
