...
- [callStatic](L1_ERC20_Bridge.md#callstatic)
- [estimateGas](L1_ERC20_Bridge.md#estimategas)
- [filters](L1_ERC20_Bridge.md#filters)
- [functions](L1_ERC20_Bridge.md#functions)
- [interface](L1_ERC20_Bridge.md#interface)
- [off](L1_ERC20_Bridge.md#off)
- [on](L1_ERC20_Bridge.md#on)
- [once](L1_ERC20_Bridge.md#once)
- [populateTransaction](L1_ERC20_Bridge.md#populatetransaction)
- [removeListener](L1_ERC20_Bridge.md#removelistener)

### Methods

- [CHALLENGE\_AMOUNT\_DIVISOR](L1_ERC20_Bridge.md#challenge_amount_divisor)
- [TIME\_SLOT\_SIZE](L1_ERC20_Bridge.md#time_slot_size)
- [addBonder](L1_ERC20_Bridge.md#addbonder)
- [attach](L1_ERC20_Bridge.md#attach)
- [bondTransferRoot](L1_ERC20_Bridge.md#bondtransferroot)
- [bondWithdrawal](L1_ERC20_Bridge.md#bondwithdrawal)
- [chainBalance](L1_ERC20_Bridge.md#chainbalance)
- [challengePeriod](L1_ERC20_Bridge.md#challengeperiod)
- [challengeResolutionPeriod](L1_ERC20_Bridge.md#challengeresolutionperiod)
- [challengeTransferBond](L1_ERC20_Bridge.md#challengetransferbond)
- [confirmTransferRoot](L1_ERC20_Bridge.md#confirmtransferroot)
- [connect](L1_ERC20_Bridge.md#connect)
- [crossDomainMessengerWrappers](L1_ERC20_Bridge.md#crossdomainmessengerwrappers)
- [deployed](L1_ERC20_Bridge.md#deployed)
- [getBondForTransferAmount](L1_ERC20_Bridge.md#getbondfortransferamount)
- [getBondedWithdrawalAmount](L1_ERC20_Bridge.md#getbondedwithdrawalamount)
- [getChainId](L1_ERC20_Bridge.md#getchainid)
- [getChallengeAmountForTransferAmount](L1_ERC20_Bridge.md#getchallengeamountfortransferamount)
- [getCredit](L1_ERC20_Bridge.md#getcredit)
- [getDebitAndAdditionalDebit](L1_ERC20_Bridge.md#getdebitandadditionaldebit)
- [getIsBonder](L1_ERC20_Bridge.md#getisbonder)
- [getRawDebit](L1_ERC20_Bridge.md#getrawdebit)
- [getTimeSlot](L1_ERC20_Bridge.md#gettimeslot)
- [getTransferId](L1_ERC20_Bridge.md#gettransferid)
- [getTransferRoot](L1_ERC20_Bridge.md#gettransferroot)
- [getTransferRootId](L1_ERC20_Bridge.md#gettransferrootid)
- [governance](L1_ERC20_Bridge.md#governance)
- [isChainIdPaused](L1_ERC20_Bridge.md#ischainidpaused)
- [isTransferIdSpent](L1_ERC20_Bridge.md#istransferidspent)
- [l1CanonicalToken](L1_ERC20_Bridge.md#l1canonicaltoken)
- [listeners](L1_ERC20_Bridge.md#listeners)
- [minTransferRootBondDelay](L1_ERC20_Bridge.md#mintransferrootbonddelay)
- [queryFilter](L1_ERC20_Bridge.md#queryfilter)
- [removeAllListeners](L1_ERC20_Bridge.md#removealllisteners)
- [removeBonder](L1_ERC20_Bridge.md#removebonder)
- [rescueTransferRoot](L1_ERC20_Bridge.md#rescuetransferroot)
- [resolveChallenge](L1_ERC20_Bridge.md#resolvechallenge)
- [sendToL2](L1_ERC20_Bridge.md#sendtol2)
- [setChainIdDepositsPaused](L1_ERC20_Bridge.md#setchainiddepositspaused)
- [setChallengePeriod](L1_ERC20_Bridge.md#setchallengeperiod)
- [setChallengeResolutionPeriod](L1_ERC20_Bridge.md#setchallengeresolutionperiod)
- [setCrossDomainMessengerWrapper](L1_ERC20_Bridge.md#setcrossdomainmessengerwrapper)
- [setGovernance](L1_ERC20_Bridge.md#setgovernance)
- [setMinTransferRootBondDelay](L1_ERC20_Bridge.md#setmintransferrootbonddelay)
- [settleBondedWithdrawal](L1_ERC20_Bridge.md#settlebondedwithdrawal)
- [settleBondedWithdrawals](L1_ERC20_Bridge.md#settlebondedwithdrawals)
- [stake](L1_ERC20_Bridge.md#stake)
- [timeSlotToAmountBonded](L1_ERC20_Bridge.md#timeslottoamountbonded)
- [transferBonds](L1_ERC20_Bridge.md#transferbonds)
- [transferRootCommittedAt](L1_ERC20_Bridge.md#transferrootcommittedat)
- [unstake](L1_ERC20_Bridge.md#unstake)
- [withdraw](L1_ERC20_Bridge.md#withdraw)
...
| `challengeTransferBond` | (`rootHash`: `PromiseOrValue`\<`BytesLike`\>, `originalAmount`: `PromiseOrValue`\<`BigNumberish`\>, `destinationChainId`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `CallOverrides`) => `Promise`\<`void`\> |
...
| `resolveChallenge` | (`rootHash`: `PromiseOrValue`\<`BytesLike`\>, `originalAmount`: `PromiseOrValue`\<`BigNumberish`\>, `destinationChainId`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `CallOverrides`) => `Promise`\<`void`\> |
...
| `transferRootCommittedAt` | (`arg0`: `PromiseOrValue`\<`BigNumberish`\>, `arg1`: `PromiseOrValue`\<`BytesLike`\>, `overrides?`: `CallOverrides`) => `Promise`\<`BigNumber`\> |
...
| `challengePeriod` | (`overrides?`: `CallOverrides`) => `Promise`\<`BigNumber`\> |
| `challengeResolutionPeriod` | (`overrides?`: `CallOverrides`) => `Promise`\<`BigNumber`\> |
| `challengeTransferBond` | (`rootHash`: `PromiseOrValue`\<`BytesLike`\>, `originalAmount`: `PromiseOrValue`\<`BigNumberish`\>, `destinationChainId`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `PayableOverrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  }) => `Promise`\<`BigNumber`\> |
...
| `resolveChallenge` | (`rootHash`: `PromiseOrValue`\<`BytesLike`\>, `originalAmount`: `PromiseOrValue`\<`BigNumberish`\>, `destinationChainId`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `Overrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  }) => `Promise`\<`BigNumber`\> |
...
| `challengePeriod` | (`overrides?`: `CallOverrides`) => `Promise`\<[`BigNumber`]\> |
| `challengeResolutionPeriod` | (`overrides?`: `CallOverrides`) => `Promise`\<[`BigNumber`]\> |
| `challengeTransferBond` | (`rootHash`: `PromiseOrValue`\<`BytesLike`\>, `originalAmount`: `PromiseOrValue`\<`BigNumberish`\>, `destinationChainId`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `PayableOverrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  }) => `Promise`\<`ContractTransaction`\> |
...
| `resolveChallenge` | (`rootHash`: `PromiseOrValue`\<`BytesLike`\>, `originalAmount`: `PromiseOrValue`\<`BigNumberish`\>, `destinationChainId`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `Overrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  }) => `Promise`\<`ContractTransaction`\> |
...
• **interface**: `L1_ERC20_BridgeInterface`
...
• **off**: `OnEvent`\<[`L1_ERC20_Bridge`](L1_ERC20_Bridge.md)\>
...
• **on**: `OnEvent`\<[`L1_ERC20_Bridge`](L1_ERC20_Bridge.md)\>
...
• **once**: `OnEvent`\<[`L1_ERC20_Bridge`](L1_ERC20_Bridge.md)\>
...
| `challengeTransferBond` | (`rootHash`: `PromiseOrValue`\<`BytesLike`\>, `originalAmount`: `PromiseOrValue`\<`BigNumberish`\>, `destinationChainId`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `PayableOverrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  }) => `Promise`\<`PopulatedTransaction`\> |
...
| `resolveChallenge` | (`rootHash`: `PromiseOrValue`\<`BytesLike`\>, `originalAmount`: `PromiseOrValue`\<`BigNumberish`\>, `destinationChainId`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `Overrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  }) => `Promise`\<`PopulatedTransaction`\> |
...
| `transferRootCommittedAt` | (`arg0`: `PromiseOrValue`\<`BigNumberish`\>, `arg1`: `PromiseOrValue`\<`BytesLike`\>, `overrides?`: `CallOverrides`) => `Promise`\<`PopulatedTransaction`\> |
...
• **removeListener**: `OnEvent`\<[`L1_ERC20_Bridge`](L1_ERC20_Bridge.md)\>
...
▸ **challengeTransferBond**(`rootHash`, `originalAmount`, `destinationChainId`, `overrides?`): `Promise`\<`ContractTransaction`\>
...
▸ **deployed**(): `Promise`\<[`L1_ERC20_Bridge`](L1_ERC20_Bridge.md)\>

#### Returns

`Promise`\<[`L1_ERC20_Bridge`](L1_ERC20_Bridge.md)\>
...
### <a id="l1canonicaltoken" name="l1canonicaltoken"></a> l1CanonicalToken

▸ **l1CanonicalToken**(`overrides?`): `Promise`\<`string`\>
...
▸ **resolveChallenge**(`rootHash`, `originalAmount`, `destinationChainId`, `overrides?`): `Promise`\<`ContractTransaction`\>
...
▸ **transferRootCommittedAt**(`arg0`, `arg1`, `overrides?`): `Promise`\<`BigNumber`\>
