          ...
          <Box>
            <form onSubmit={handleSubmit}>
              ...
              <Box mb={2}>
                ...
                <CustomTextField fullWidth placeholder="0" value={amount} onChange={(event: any) => setMinAmountOut(event.target.value)} />
              </Box>
              ...
              <Box mb={2}>
                ...
                <CustomTextField fullWidth placeholder="0x" value={amount} onChange={(event: any) => setAttestedCheckpoint(event.target.value)} />
              </Box>
              ...
              <Box mb={2}>
                ...
                <CustomTextField fullWidth placeholder="0x" value={amount} onChange={(event: any) => setPathId(event.target.value)} />
              </Box>
