  ...
  bonders: {
    ...
    USDT: {
      ethereum: {
        ...
        arbitrum: '0x698d6c5475e95aa821b4ed4913831b96f6680ec9',
        gnosis: '0x698d6c5475e95aa821b4ed4913831b96f6680ec9',
        polygon: '0x698d6c5475e95aa821b4ed4913831b96f6680ec9'
      },
      optimism: {
        ethereum: '0x698d6c5475e95aa821b4ed4913831b96f6680ec9',
        arbitrum: '0x698d6c5475e95aa821b4ed4913831b96f6680ec9',
        gnosis: '0x698d6c5475e95aa821b4ed4913831b96f6680ec9',
        polygon: '0x698d6c5475e95aa821b4ed4913831b96f6680ec9'
      },
    ...
    DAI: {
      ...
      optimism: {
        ethereum: '0x10720f58Cf4A22fa540ff10430fD967d2ef102de',
        arbitrum: '0x10720f58Cf4A22fa540ff10430fD967d2ef102de',
        gnosis: '0x10720f58Cf4A22fa540ff10430fD967d2ef102de',
        polygon: '0x10720f58Cf4A22fa540ff10430fD967d2ef102de'
      },
    ...
    ETH: {
      ethereum: {
        ...
        linea: '0x710bDa329b2a6224E4B44833DE30F38E7f81d564',
        polygonzk: '0x710bDa329b2a6224E4B44833DE30F38E7f81d564'
      },
      optimism: {
    ...
    HOP: {
      ethereum: {
        ...
        linea: '0x881296Edcb252080bd476c464cEB521d08df7631',
        polygonzk: '0x881296Edcb252080bd476c464cEB521d08df7631'
      },
      optimism: {
  ...
  rewardsContracts: {
    ...
    ETH: {
      ...
      linea: [
        ...
        '0xD063875762e760Ee787b11F6Af624058b4841A5a' // HOP
      ],
      polygonzk: ['0xfF21e82a4Bc305BCE591530A68628192b5b6B6FD'] // HOP
    },
    SNX: {
      optimism: [
        '0x25a5A48C35e75BD2EFf53D94f0BB60d5A00E36ea', // HOP
        '0x09992Dd7B32f7b35D347DE9Bdaf1919a57d38E82' // OP
      ]
    },
    sUSD: {
      optimism: [
        '0x2935008eE9943f859C4fbb863c5402fFC06f462E', // HOP
        '0x25FB92E505F752F730cAD0Bd4fa17ecE4A384266' // OP
      ]
    },
    rETH: {
      arbitrum: ['0x3D4cAD734B464Ed6EdCF6254C2A3e5fA5D449b32'], // RPL
      optimism: ['0x266e2dc3C4c59E42AA07afeE5B09E964cFFe6778'] // RPL
    },
    MAGIC: {
      arbitrum: ['0x4e9840f3C1ff368a10731D15c11516b9Fe7E1898'], // HOP
      nova: ['0xeB35Dac45077319042D62a735aa0f9eDD1F01Fa6'] // HOP
    }
  },
  bridges: {
    USDC: {
      ethereum: {
        ...
        cctpBridgeDeployedBlockNumber: 19466442
      },
      polygon: {
    ...
    ETH: {
      ...
      linea: {
        l1CanonicalBridge: '0x0000000000000000000000000000000000000000',
        l1MessengerWrapper: '0x789Ac91519a3344E4845E12870F3364E7Df26D23',
        l2CanonicalBridge: '0x0000000000000000000000000000000000000000',
        l2CanonicalToken: '0xe5D7C2a44FfDDf6b295A15c148167daaAf5Cf34f',
