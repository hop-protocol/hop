...
export interface MessageBridgeInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "getXDomainChainId",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getXDomainData",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getXDomainSender",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "relayedMessage",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
