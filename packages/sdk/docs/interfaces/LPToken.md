...
- [callStatic](LPToken.md#callstatic)
- [estimateGas](LPToken.md#estimategas)
- [filters](LPToken.md#filters)
- [functions](LPToken.md#functions)
- [interface](LPToken.md#interface)
- [off](LPToken.md#off)
- [on](LPToken.md#on)
- [once](LPToken.md#once)
- [populateTransaction](LPToken.md#populatetransaction)
- [removeListener](LPToken.md#removelistener)

### Methods

- [allowance](LPToken.md#allowance)
- [approve](LPToken.md#approve)
- [attach](LPToken.md#attach)
- [balanceOf](LPToken.md#balanceof)
- [burn](LPToken.md#burn)
- [burnFrom](LPToken.md#burnfrom)
- [connect](LPToken.md#connect)
- [decimals](LPToken.md#decimals)
- [decreaseAllowance](LPToken.md#decreaseallowance)
- [deployed](LPToken.md#deployed)
- [increaseAllowance](LPToken.md#increaseallowance)
- [listeners](LPToken.md#listeners)
- [mint](LPToken.md#mint)
- [name](LPToken.md#name)
- [owner](LPToken.md#owner)
- [queryFilter](LPToken.md#queryfilter)
- [removeAllListeners](LPToken.md#removealllisteners)
- [renounceOwnership](LPToken.md#renounceownership)
- [swap](LPToken.md#swap)
- [symbol](LPToken.md#symbol)
- [totalSupply](LPToken.md#totalsupply)
- [transfer](LPToken.md#transfer)
- [transferFrom](LPToken.md#transferfrom)
- [transferOwnership](LPToken.md#transferownership)
...
| `mint` | (`recipient`: `PromiseOrValue`\<`string`\>, `amount`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `Overrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  }) => `Promise`\<`BigNumber`\> |
...
| `mint` | (`recipient`: `PromiseOrValue`\<`string`\>, `amount`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `Overrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  }) => `Promise`\<`ContractTransaction`\> |
| `name` | (`overrides?`: `CallOverrides`) => `Promise`\<[`string`]\> |
| `owner` | (`overrides?`: `CallOverrides`) => `Promise`\<[`string`]\> |
...
• **off**: `OnEvent`\<[`LPToken`](LPToken.md)\>
...
• **once**: `OnEvent`\<[`LPToken`](LPToken.md)\>
...
| `mint` | (`recipient`: `PromiseOrValue`\<`string`\>, `amount`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `Overrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  }) => `Promise`\<`PopulatedTransaction`\> |
...
• **removeListener**: `OnEvent`\<[`LPToken`](LPToken.md)\>
...
▸ **deployed**(): `Promise`\<[`LPToken`](LPToken.md)\>

#### Returns

`Promise`\<[`LPToken`](LPToken.md)\>
...
▸ **mint**(`recipient`, `amount`, `overrides?`): `Promise`\<`ContractTransaction`\>
