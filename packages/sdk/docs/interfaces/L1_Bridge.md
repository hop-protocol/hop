...
- [callStatic](L1_Bridge.md#callstatic)
- [estimateGas](L1_Bridge.md#estimategas)
- [filters](L1_Bridge.md#filters)
- [functions](L1_Bridge.md#functions)
- [interface](L1_Bridge.md#interface)
- [off](L1_Bridge.md#off)
- [on](L1_Bridge.md#on)
- [once](L1_Bridge.md#once)
- [populateTransaction](L1_Bridge.md#populatetransaction)
- [removeListener](L1_Bridge.md#removelistener)

### Methods

- [CHALLENGE\_AMOUNT\_DIVISOR](L1_Bridge.md#challenge_amount_divisor)
- [TIME\_SLOT\_SIZE](L1_Bridge.md#time_slot_size)
- [addBonder](L1_Bridge.md#addbonder)
- [attach](L1_Bridge.md#attach)
- [bondTransferRoot](L1_Bridge.md#bondtransferroot)
- [bondWithdrawal](L1_Bridge.md#bondwithdrawal)
- [chainBalance](L1_Bridge.md#chainbalance)
- [challengePeriod](L1_Bridge.md#challengeperiod)
- [challengeResolutionPeriod](L1_Bridge.md#challengeresolutionperiod)
- [challengeTransferBond](L1_Bridge.md#challengetransferbond)
- [confirmTransferRoot](L1_Bridge.md#confirmtransferroot)
- [connect](L1_Bridge.md#connect)
- [crossDomainMessengerWrappers](L1_Bridge.md#crossdomainmessengerwrappers)
- [deployed](L1_Bridge.md#deployed)
- [getBondForTransferAmount](L1_Bridge.md#getbondfortransferamount)
- [getBondedWithdrawalAmount](L1_Bridge.md#getbondedwithdrawalamount)
- [getChainId](L1_Bridge.md#getchainid)
- [getChallengeAmountForTransferAmount](L1_Bridge.md#getchallengeamountfortransferamount)
- [getCredit](L1_Bridge.md#getcredit)
- [getDebitAndAdditionalDebit](L1_Bridge.md#getdebitandadditionaldebit)
- [getIsBonder](L1_Bridge.md#getisbonder)
- [getRawDebit](L1_Bridge.md#getrawdebit)
- [getTimeSlot](L1_Bridge.md#gettimeslot)
- [getTransferId](L1_Bridge.md#gettransferid)
- [getTransferRoot](L1_Bridge.md#gettransferroot)
- [getTransferRootId](L1_Bridge.md#gettransferrootid)
- [governance](L1_Bridge.md#governance)
- [isChainIdPaused](L1_Bridge.md#ischainidpaused)
- [isTransferIdSpent](L1_Bridge.md#istransferidspent)
- [listeners](L1_Bridge.md#listeners)
- [minTransferRootBondDelay](L1_Bridge.md#mintransferrootbonddelay)
- [queryFilter](L1_Bridge.md#queryfilter)
- [removeAllListeners](L1_Bridge.md#removealllisteners)
- [removeBonder](L1_Bridge.md#removebonder)
- [rescueTransferRoot](L1_Bridge.md#rescuetransferroot)
- [resolveChallenge](L1_Bridge.md#resolvechallenge)
- [sendToL2](L1_Bridge.md#sendtol2)
- [setChainIdDepositsPaused](L1_Bridge.md#setchainiddepositspaused)
- [setChallengePeriod](L1_Bridge.md#setchallengeperiod)
- [setChallengeResolutionPeriod](L1_Bridge.md#setchallengeresolutionperiod)
- [setCrossDomainMessengerWrapper](L1_Bridge.md#setcrossdomainmessengerwrapper)
- [setGovernance](L1_Bridge.md#setgovernance)
- [setMinTransferRootBondDelay](L1_Bridge.md#setmintransferrootbonddelay)
- [settleBondedWithdrawal](L1_Bridge.md#settlebondedwithdrawal)
- [settleBondedWithdrawals](L1_Bridge.md#settlebondedwithdrawals)
- [stake](L1_Bridge.md#stake)
- [timeSlotToAmountBonded](L1_Bridge.md#timeslottoamountbonded)
- [transferBonds](L1_Bridge.md#transferbonds)
- [transferRootCommittedAt](L1_Bridge.md#transferrootcommittedat)
- [unstake](L1_Bridge.md#unstake)
- [withdraw](L1_Bridge.md#withdraw)
...
• **off**: `OnEvent`\<[`L1_Bridge`](L1_Bridge.md)\>
...
• **on**: `OnEvent`\<[`L1_Bridge`](L1_Bridge.md)\>
...
• **once**: `OnEvent`\<[`L1_Bridge`](L1_Bridge.md)\>
...
• **removeListener**: `OnEvent`\<[`L1_Bridge`](L1_Bridge.md)\>
...
▸ **deployed**(): `Promise`\<[`L1_Bridge`](L1_Bridge.md)\>

#### Returns

`Promise`\<[`L1_Bridge`](L1_Bridge.md)\>
