# Interface: Mock\_L2\_OptimismBridge

## Hierarchy

- `BaseContract`

  ↳ **`Mock_L2_OptimismBridge`**

## Table of contents

### Properties

- [callStatic](Mock_L2_OptimismBridge.md#callstatic)
- [estimateGas](Mock_L2_OptimismBridge.md#estimategas)
- [filters](Mock_L2_OptimismBridge.md#filters)
- [functions](Mock_L2_OptimismBridge.md#functions)
- [interface](Mock_L2_OptimismBridge.md#interface)
- [off](Mock_L2_OptimismBridge.md#off)
- [on](Mock_L2_OptimismBridge.md#on)
- [once](Mock_L2_OptimismBridge.md#once)
- [populateTransaction](Mock_L2_OptimismBridge.md#populatetransaction)
- [removeListener](Mock_L2_OptimismBridge.md#removelistener)

### Methods

- [activeChainIds](Mock_L2_OptimismBridge.md#activechainids)
- [addActiveChainIds](Mock_L2_OptimismBridge.md#addactivechainids)
- [addBonder](Mock_L2_OptimismBridge.md#addbonder)
- [ammWrapper](Mock_L2_OptimismBridge.md#ammwrapper)
- [attach](Mock_L2_OptimismBridge.md#attach)
- [bondWithdrawal](Mock_L2_OptimismBridge.md#bondwithdrawal)
- [bondWithdrawalAndDistribute](Mock_L2_OptimismBridge.md#bondwithdrawalanddistribute)
- [commitTransfers](Mock_L2_OptimismBridge.md#committransfers)
- [connect](Mock_L2_OptimismBridge.md#connect)
- [defaultGasLimit](Mock_L2_OptimismBridge.md#defaultgaslimit)
- [deployed](Mock_L2_OptimismBridge.md#deployed)
- [distribute](Mock_L2_OptimismBridge.md#distribute)
- [getBondedWithdrawalAmount](Mock_L2_OptimismBridge.md#getbondedwithdrawalamount)
- [getChainId](Mock_L2_OptimismBridge.md#getchainid)
- [getCredit](Mock_L2_OptimismBridge.md#getcredit)
- [getDebitAndAdditionalDebit](Mock_L2_OptimismBridge.md#getdebitandadditionaldebit)
- [getIsBonder](Mock_L2_OptimismBridge.md#getisbonder)
- [getNextTransferNonce](Mock_L2_OptimismBridge.md#getnexttransfernonce)
- [getRawDebit](Mock_L2_OptimismBridge.md#getrawdebit)
- [getTransferId](Mock_L2_OptimismBridge.md#gettransferid)
- [getTransferRoot](Mock_L2_OptimismBridge.md#gettransferroot)
- [getTransferRootId](Mock_L2_OptimismBridge.md#gettransferrootid)
- [hToken](Mock_L2_OptimismBridge.md#htoken)
- [isTransferIdSpent](Mock_L2_OptimismBridge.md#istransferidspent)
- [l1BridgeAddress](Mock_L2_OptimismBridge.md#l1bridgeaddress)
- [l1BridgeCaller](Mock_L2_OptimismBridge.md#l1bridgecaller)
- [l1Governance](Mock_L2_OptimismBridge.md#l1governance)
- [lastCommitTimeForChainId](Mock_L2_OptimismBridge.md#lastcommittimeforchainid)
- [listeners](Mock_L2_OptimismBridge.md#listeners)
- [maxPendingTransfers](Mock_L2_OptimismBridge.md#maxpendingtransfers)
- [messenger](Mock_L2_OptimismBridge.md#messenger)
- [minBonderBps](Mock_L2_OptimismBridge.md#minbonderbps)
- [minBonderFeeAbsolute](Mock_L2_OptimismBridge.md#minbonderfeeabsolute)
- [minimumForceCommitDelay](Mock_L2_OptimismBridge.md#minimumforcecommitdelay)
- [pendingAmountForChainId](Mock_L2_OptimismBridge.md#pendingamountforchainid)
- [pendingTransferIdsForChainId](Mock_L2_OptimismBridge.md#pendingtransferidsforchainid)
- [queryFilter](Mock_L2_OptimismBridge.md#queryfilter)
- [removeActiveChainIds](Mock_L2_OptimismBridge.md#removeactivechainids)
- [removeAllListeners](Mock_L2_OptimismBridge.md#removealllisteners)
- [removeBonder](Mock_L2_OptimismBridge.md#removebonder)
- [rescueTransferRoot](Mock_L2_OptimismBridge.md#rescuetransferroot)
- [send](Mock_L2_OptimismBridge.md#send)
- [setAmmWrapper](Mock_L2_OptimismBridge.md#setammwrapper)
- [setDefaultGasLimit](Mock_L2_OptimismBridge.md#setdefaultgaslimit)
- [setHopBridgeTokenOwner](Mock_L2_OptimismBridge.md#sethopbridgetokenowner)
- [setL1BridgeAddress](Mock_L2_OptimismBridge.md#setl1bridgeaddress)
- [setL1BridgeCaller](Mock_L2_OptimismBridge.md#setl1bridgecaller)
- [setL1Governance](Mock_L2_OptimismBridge.md#setl1governance)
- [setMaxPendingTransfers](Mock_L2_OptimismBridge.md#setmaxpendingtransfers)
- [setMessenger](Mock_L2_OptimismBridge.md#setmessenger)
- [setMinimumBonderFeeRequirements](Mock_L2_OptimismBridge.md#setminimumbonderfeerequirements)
- [setMinimumForceCommitDelay](Mock_L2_OptimismBridge.md#setminimumforcecommitdelay)
- [setTransferRoot](Mock_L2_OptimismBridge.md#settransferroot)
- [settleBondedWithdrawal](Mock_L2_OptimismBridge.md#settlebondedwithdrawal)
- [settleBondedWithdrawals](Mock_L2_OptimismBridge.md#settlebondedwithdrawals)
- [stake](Mock_L2_OptimismBridge.md#stake)
- [transferNonceIncrementer](Mock_L2_OptimismBridge.md#transfernonceincrementer)
- [unstake](Mock_L2_OptimismBridge.md#unstake)
- [withdraw](Mock_L2_OptimismBridge.md#withdraw)
...
| `setDefaultGasLimit` | (`_defaultGasLimit`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `CallOverrides`) => `Promise`\<`void`\> |
...
| `setDefaultGasLimit` | (`_defaultGasLimit`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `Overrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  }) => `Promise`\<`BigNumber`\> |
...
| `setDefaultGasLimit` | (`_defaultGasLimit`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `Overrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  }) => `Promise`\<`ContractTransaction`\> |
...
• **interface**: `Mock_L2_OptimismBridgeInterface`
...
• **off**: `OnEvent`\<[`Mock_L2_OptimismBridge`](Mock_L2_OptimismBridge.md)\>
...
• **on**: `OnEvent`\<[`Mock_L2_OptimismBridge`](Mock_L2_OptimismBridge.md)\>
...
• **once**: `OnEvent`\<[`Mock_L2_OptimismBridge`](Mock_L2_OptimismBridge.md)\>
...
| `setDefaultGasLimit` | (`_defaultGasLimit`: `PromiseOrValue`\<`BigNumberish`\>, `overrides?`: `Overrides` & \{ `from?`: `PromiseOrValue`\<`string`\>  }) => `Promise`\<`PopulatedTransaction`\> |
...
• **removeListener**: `OnEvent`\<[`Mock_L2_OptimismBridge`](Mock_L2_OptimismBridge.md)\>
...
▸ **deployed**(): `Promise`\<[`Mock_L2_OptimismBridge`](Mock_L2_OptimismBridge.md)\>

#### Returns

`Promise`\<[`Mock_L2_OptimismBridge`](Mock_L2_OptimismBridge.md)\>
...
### <a id="setdefaultgaslimit" name="setdefaultgaslimit"></a> setDefaultGasLimit

▸ **setDefaultGasLimit**(`_defaultGasLimit`, `overrides?`): `Promise`\<`ContractTransaction`\>
