...
export interface ExecutorManagerInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "defaultTransporter",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "isBundleVerified",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>,
      PromiseOrValue<BytesLike>,
  ...
  encodeFunctionData(
    functionFragment: "registedTransporters",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "registerMessageReceiver",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setDefaultTransporter",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "verifiedBundleIds",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>
...
export type VerifierRegisteredEventFilter =
  TypedEventFilter<VerifierRegisteredEvent>;
...
export interface ExecutorManager extends BaseContract {
  ...
  functions: {
    ...
    isBundleVerified(
      ...
      messageReceiver: PromiseOrValue<string>,
      overrides?: CallOverrides
    ): Promise<[boolean]>;
    ...
    proveBundle(
      transportLayer: PromiseOrValue<string>,
      fromChainId: PromiseOrValue<BigNumberish>,
      bundleNonce: PromiseOrValue<BytesLike>,
      bundleRoot: PromiseOrValue<BytesLike>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
  ...
  filters: {
    ...
    "VerifierRegistered(address,address)"(
      receiver?: PromiseOrValue<string> | null,
      transporter?: PromiseOrValue<string> | null
    ): VerifierRegisteredEventFilter;
    VerifierRegistered(
      receiver?: PromiseOrValue<string> | null,
      transporter?: PromiseOrValue<string> | null
    ): VerifierRegisteredEventFilter;
