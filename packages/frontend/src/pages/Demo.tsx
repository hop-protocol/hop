      ...
      <Button
        ...
        onClick={async () => {
          ...
          await signer?.sendTransaction({
            ...
            // data: ''
          })
          console.log('after')
        }}
        large
