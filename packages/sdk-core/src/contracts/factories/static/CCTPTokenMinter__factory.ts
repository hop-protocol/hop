...
export class CCTPTokenMinter__factory {
  static readonly abi = _abi;
  static createInterface(): CCTPTokenMinterInterface {
    return new utils.Interface(_abi) as CCTPTokenMinterInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CCTPTokenMinter {
    return new Contract(address, _abi, signerOrProvider) as CCTPTokenMinter;
  }
}
