    ...
    <div id="t" class="offline">
        <div id="main-frame-error" class="interstitial-wrapper">
            ...
            <div id="offline-resources">
                <img id="offline-resources-1x" src="https://assets.hop.exchange/dino-game/100-offline-sprite.png">
                <img id="offline-resources-2x" src="https://assets.hop.exchange/dino-game/200-offline-sprite.png">
