...
export interface SpokeTransporterInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "getChainId"
      | "hubChainId"
      | "hubTransporterConnector"
      | "isCommitmentProven"
      | "owner"
      | "payRelayerFee"
      | "pendingBundleNonceForChainId"
      | "pendingFeeBatchSize"
  ...
  encodeFunctionData(
    functionFragment: "feeForCommitment",
  ...
  encodeFunctionData(
    functionFragment: "hubTransporterConnector",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "payRelayerFee",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "pendingBundleNonceForChainId",
  ...
  encodeFunctionData(
    functionFragment: "receiveCommitment",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
...
export type ExcessFeesDistributedEventFilter =
  TypedEventFilter<ExcessFeesDistributedEvent>;
...
export interface SpokeTransporter extends BaseContract {
  ...
  functions: {
    ...
    setHubConnector(
      _hubTransporterConnector: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "ExcessFeesDistributed(address,uint256)"(
      to?: PromiseOrValue<string> | null,
      amount?: null
    ): ExcessFeesDistributedEventFilter;
    ExcessFeesDistributed(
      to?: PromiseOrValue<string> | null,
      amount?: null
    ): ExcessFeesDistributedEventFilter;
