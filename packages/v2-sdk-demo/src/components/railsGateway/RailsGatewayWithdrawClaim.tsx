...
export function RailsGatewayWithdrawClaim (props: Props) {
  const cacheKey = 'railsGatewayWithdrawClaim'
...
`.trim()
  ...
  return (
    <Box>
      <Box mb={1}>
        <Typography variant="h5">Rails Gateway - Withdraw Claim</Typography>
      </Box>
      <Box mb={4}>
        <Typography variant="subtitle1">Withdraw a claim from the rails gateway</Typography>
      </Box>
...
export default RailsGatewayWithdrawClaim
