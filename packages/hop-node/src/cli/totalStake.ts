...
import { ChainSlug, getToken } from '@hop-protocol/sdk'
...
async function main (source: any) {
  ...
  const chains = [ChainSlug.Ethereum, ChainSlug.Polygon, ChainSlug.Gnosis, ChainSlug.Optimism, ChainSlug.Arbitrum, ChainSlug.Nova, ChainSlug.Base, ChainSlug.Linea, ChainSlug.PolygonZk]
