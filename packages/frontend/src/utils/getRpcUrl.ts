...
export const getRpcUrl = (network: string) => {
  ...
  // make mainnet rpc available when react app network is testnet
  if (!networkRpcUrl && network === 'ethereum') {
    networkRpcUrl = 'https://mainnet.infura.io/v3/84842078b09946638c03157f83405213' // infura id is from ethers
  }
