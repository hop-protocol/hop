...
export interface HubERC5164ConnectorFactoryInterface extends utils.Interface {
    functions: {
        ...
        "deployConnectors(uint256,address,uint256,address)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "calculateAddress" | "deployConnector" | "deployConnectors" | "getChainId" | "getFee" | "getSalt" | "messageDispatcher" | "messageExecutor"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "deployConnectors", values: [
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<string>
    ...
    decodeFunctionResult(functionFragment: "deployConnectors", data: BytesLike): Result;
...
export interface HubERC5164ConnectorFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HubERC5164ConnectorFactoryInterface;
    ...
    functions: {
        ...
        deployConnectors(chainId1: PromiseOrValue<BigNumberish>, target1: PromiseOrValue<string>, chainId2: PromiseOrValue<BigNumberish>, target2: PromiseOrValue<string>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        deployConnectors(chainId1: PromiseOrValue<BigNumberish>, target1: PromiseOrValue<string>, chainId2: PromiseOrValue<BigNumberish>, target2: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>;
        getChainId(overrides?: CallOverrides): Promise<BigNumber>;
        getFee(chainIds: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<BigNumber>;
        getSalt(target1: PromiseOrValue<string>, chainId1: PromiseOrValue<BigNumberish>, target2: PromiseOrValue<string>, chainId2: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
        messageDispatcher(overrides?: CallOverrides): Promise<string>;
...
//# sourceMappingURL=HubERC5164ConnectorFactory.d.ts.map