...
} from "../../static/CCTPTokenMessenger";
...
export class CCTPTokenMessenger__factory {
  static readonly abi = _abi;
  static createInterface(): CCTPTokenMessengerInterface {
    return new utils.Interface(_abi) as CCTPTokenMessengerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CCTPTokenMessenger {
    return new Contract(address, _abi, signerOrProvider) as CCTPTokenMessenger;
  }
}
