      ...
      <Table 
        ...
        filters={
          ...
          >
            ...
            <TextField 
              placeholder={filterBy === 'bundleId' ? 'Enter bundle ID' : filterBy === 'bundleRoot' ? 'Enter bundle root' : filterBy === 'relayer' ? 'Enter relayer address' : filterBy === 'toChainId' ? 'Enter chain ID' : 'Enter 0x...'}
              value={filterValue} 
