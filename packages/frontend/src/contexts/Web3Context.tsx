      ...
      if (state.address) {
        ...
        if (isL1) {
          ...
          if (shouldSkipAddingChain) {
            throw new NetworkSwitchError(`Please add or switch to Linea (Goerli) [networkId ${59140}] in your wallet first and then try again. More info: https://docs.zkevm.consensys.net/use-zkevm/set-up-your-wallet`)
          }
