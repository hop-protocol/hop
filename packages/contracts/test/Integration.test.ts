...
describe("Full story", () => {
  ...
  before(async () => {
    ...
    L1_BridgeWrapper = await ethers.getContractFactory('contracts/wrappers/Arbitrum.sol')
    globalInbox = await ethers.getContractFactory('contracts/test/arbitrum/inbox/GlobalInbox.sol')
