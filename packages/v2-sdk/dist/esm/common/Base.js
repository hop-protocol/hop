...
import { getProviderFromUrl, rateLimitRetry, getNetwork } from '@hop-protocol/sdk';
...
export class Base {
    ...
    getDefaultChainRpcProvider(chainId) {
        ...
        const chains = getNetwork(this.network).chains;
    ...
    get utils() {
        return {
            ...
            getGasPrice: rateLimitRetry(async (signerOrProvider) => {
                if (!signerOrProvider) {
