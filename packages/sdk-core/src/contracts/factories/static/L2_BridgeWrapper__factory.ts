...
export class L2_BridgeWrapper__factory {
  static readonly abi = _abi;
  static createInterface(): L2_BridgeWrapperInterface {
    return new utils.Interface(_abi) as L2_BridgeWrapperInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): L2_BridgeWrapper {
    return new Contract(address, _abi, signerOrProvider) as L2_BridgeWrapper;
  }
}
