...
export interface HubMessageBridgeInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "getHubMessageId",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getSpokeBridge",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "receiveOrForwardMessageBundle",
    values: [
      PromiseOrValue<BytesLike>,
      PromiseOrValue<BytesLike>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "setSpokeBridge",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
...
export interface HubMessageBridge extends BaseContract {
  ...
  functions: {
    ...
    getRelayReward(
      fromChainId: PromiseOrValue<BigNumberish>,
      bundleFees: PromiseOrValue<BigNumberish>,
    ...
    setSpokeBridge(
      chainId: PromiseOrValue<BigNumberish>,
      spokeBridge: PromiseOrValue<string>,
  ...
  filters: {
    "BundleForwarded(bytes32,bytes32,uint256,uint256)"(
    ...
    "BundleReceived(bytes32,bytes32,uint256,uint256,uint256,uint256,address)"(
      bundleId?: PromiseOrValue<BytesLike> | null,
      bundleRoot?: null,
      bundleFees?: null,
      fromChainId?: null,
