...
export default class L2Amm extends ContractBase {
  ...
  swap = rateLimitRetry((fromTokenIndex: number, toTokenIndex: number, amountIn: BigNumber, minAmountOut: BigNumber = BigNumber.from(0), deadline: number = this.defaultDeadline()):Promise<BigNumber> => {
