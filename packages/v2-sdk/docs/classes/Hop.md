...
▸ **getEvents**(`«destructured»`): `Promise`\<`EthersEventWithDecodedTypes`\<`AllEventTypes`\>[]\>
...
`Promise`\<`EthersEventWithDecodedTypes`\<`AllEventTypes`\>[]\>
...
| Name | Type |
| :------ | :------ |
| `input` | `GetNeedsApprovalForSendTokensInput` |
...
| Name | Type |
| :------ | :------ |
| `«destructured»` | `WillSendTokensFailInput` |
