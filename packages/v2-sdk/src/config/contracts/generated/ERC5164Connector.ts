...
export interface ERC5164ConnectorInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "initialize(address,address,address,address,uint256)",
    values: [
...
export interface ERC5164Connector extends BaseContract {
  ...
  functions: {
    ...
    "initialize(address,address,address,address,uint256)"(
      ...
      counterpart: PromiseOrValue<string>,
      _messageDispatcher: PromiseOrValue<string>,
      _messageExecutor: PromiseOrValue<string>,
