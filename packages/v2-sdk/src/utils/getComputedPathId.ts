...
export function getComputedPathId(chainId0: BigNumberish, token0: string, chainId1: BigNumberish, token1: string): string {
  ...
  return utils.keccak256(
    utils.solidityPack(['uint256', 'address', 'uint256', 'address'], [
      chainIdA,
      tokenA,
      chainIdB,
      tokenB
