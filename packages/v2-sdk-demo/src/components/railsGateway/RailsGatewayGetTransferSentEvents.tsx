...
export function RailsGatewayGetTransferSentEvents (props: Props) {
...
`.trim()
  ...
  return (
    <Box>
      <Box mb={1}>
        <Typography variant="h5">Rails Gateway - Get Transfer Sent Events</Typography>
      </Box>
      <Box mb={4}>
        <Typography variant="subtitle1">Get decoded transfer sent events</Typography>
      </Box>
