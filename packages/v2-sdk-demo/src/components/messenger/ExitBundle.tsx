...
export function ExitBundle (props: Props) {
  ...
  const [bundleCommittedTxHash, setBundleCommittedTxHash] = useLocalStorageState(`${cacheKey}:bundleCommittedTxHash`, {
    defaultValue: '',
  })
...
`.trim()
  ...
  return (
    <Box>
      <Box mb={1}>
        <Typography variant="h5">Messenger - Exit Bundle</Typography>
      </Box>
      <Box mb={4}>
